...
- **Status:** Pass 38 open; 3 findings (1 HIGH Burst 38 regression + 2 OBS); Burst 39 pending
...
pass-12)→26→8→4→2→1→1→3→6→12→8→6→7→3→14→15→9→5→5→4→6→2→**3**→**3**→**12**→**4**→**3**→**3**; BLOCK at 0/3; Burst 39 pending;
...
| pass-38 | findings-open | 3 | [pass-38.md](adversarial-reviews/pass-38.md) |
