...
29→24→21→7→4→3→2→CLEAN→26→8→4→2→1→1→3→6→12→8→6→7→3→14→15→9→5→5→4→6→2→3→3→12→4→3→3→8→4→3→0→5→…(pre-build sweep reset)→11→6→4→1→3→3→2→1→CLEAN(p67)→CLEAN(p68)→CLEAN(p69) counter=3/3 **RE-CONVERGENCE ACHIEVED** → housekeeping RESET →8(p70)→7(p71)→5(p72)→p73-deterministic→4(p74)→6(p75)→6(p76)→6(p77) counter=0/3 (7-pass adjacent-regression plateau)
