...
## Archived: D-2326 — 2026-08-26; STATE v8.858→v8.859 — F-R11-CRIT-001 plan-shape gate REMEDIATED; feature HEAD @e59116ea8; round-12 3-CLEAN re-cascade pending

**RESUME IN ONE BREATH:** Prism Phase-3, v1 = live Claroty xDome. DEFECT-1 (claroty_vulnerabilities h2 "stall") PROVED PHANTOM — ADR-059 WITHDRAWN v1.2; xdome HTTP/1.1 relay DECOMMISSIONED. DEFECT-2 = S-ENGINE-LIMIT-EARLY-STOP-001: F-R11-CRIT-001 REMEDIATED — plan-shape gate `ast_is_reducing_plan`+`expr_contains_aggregate` guards unconditional fetch_limit push-down; fetch_limit=0 for reducing plans (Condition A: aggregation/GROUP BY/DISTINCT/HAVING; Condition B: non-temporal WHERE). Spec anchored in ADR-060 v1.2 §D8.7+§D8.8; BC-2.16.002 v2.39 +7 ECs; story v1.9 15 ACs + 9 RG-PSGs. Feature HEAD @e59116ea8 (PUSHED; just check GREEN 5836/5836). BC-5.39.001 LOCAL streak RESET 0/3 (code HEAD advanced); round-12 3-CLEAN re-cascade pending on frozen @e59116ea8. F-R11-OBS-001 RESOLVED (BC-2.16.015 trace-only; VULNS-001 is POL-14 anchor). DEFINITIVE NEXT: 3-CLEAN round-12 diverse-lens adversary batch on frozen @e59116ea8.

**SETTLED:** (1) E-SPEC-018 on PRESENT unparseable datetime HARD-ERRORS (Option A). (2) Fetch ATOMIC. (3) ColumnOptions::Required = push-down eligibility only. (4) SAP-2 DTU-parity DEFERRED D-2200. (5) table_name=`vulnerabilities` → registers as `claroty_vulnerabilities`. (6) prism-spec-engine ZERO prod changes intentional. (7) ADR-059 WITHDRAWN — direct h2 transport confirmed healthy (D-2312). (8) LIMIT from QueryParams.limit: u64 NOT DataFusion physical-plan (ADR-060 v1.1). (9) TD-VSDD-097 Dim-2: comprehensive whole-artifact grep is the correct discharge. (10) F-R11-CRIT-001: LIMIT early-stop keyed to tool result-cap confirmed D-2325. (11) F-R11-CRIT-001 FIXED: plan-shape gate `ast_is_reducing_plan`+`expr_contains_aggregate`; fetch_limit=0 for reducing plans (D-2326). (12) BC-2.16.015 trace-only from LIMIT perimeter; VULNS-001 is POL-14 promotion anchor (D-2326).

**SPEC PERIMETER (D-2326):** ADR-058 v2.34 / ADR-059 v1.2 (WITHDRAWN) / ADR-060 v1.2 (§D8.7 plan-shape gate + §D8.8 coherence LANDED) / BC-2.16.002 v2.39 (+gate clause + EC-016-002-001..007) / BC-2.16.003 v1.27 / BC-2.16.015 v1.8 (draft; trace-only) / VULNS story v1.9 / LIMIT story v1.9 (AC-007 + RG-PSG-001..009 COMPLETE) — ARCH-INDEX v2.338 / BC-INDEX v9.69 / STORY-INDEX v2.913 / VP-INDEX v2.22.
...
## Archived: D-2489 — 2026-09-07; STATE v9.016→v9.017 — PR #264 PR-LEVEL pass-3 fix-burst @c09d63593; F1/F2/O1/O2 ALL RESOLVED; streak 0/3

**RESUME IN ONE BREATH:** Phase 3, v1.0.0-beta.1 release engineering. PR #264 (feature/E-REL-NOTES-changelog; 3 stories: S-REL-CLIFF-001 + S-REL-WRITER-001 + S-REL-DROP-INTEL-MAC-001) is OPEN. PR-LEVEL adversary pass-3 on frozen HEAD c44d2f1e7 returned F1 MED + F2 LOW (comment restated banned literal) + O1 OBS (WRITER-001 AC-005 scope) + O2 OBS (ADR-064 stale body counts). ALL RESOLVED: devops comment-only fix @c09d63593; ADR-064 v2.2→v2.3 (11 stale refs fixed; AC-003 discharged); S-REL-WRITER-001 v1.1→v1.2 (AC-005 scoped to --notes-file). CLEAN(strict): NO; CLEAN(PR-merge): YES. PR-LEVEL 3-CLEAN(strict) streak 0/3 (DRIFT-ORCH-PRLEVEL-PUSH-001: push @c09d63593 resets). NEXT ACTION: re-gate PR-LEVEL adversary on frozen c09d63593.
...
## Archived: D-2509 — 2026-09-09; STATE v10.014→v10.015 — S-REL-CHANGELOG-CHANNEL-SCOPE-001 MATERIALIZED; ADR-063 §D7 PENDING; develop @54523dccd

**RESUME IN ONE BREATH:** Prism at develop@54523dccd — beta.1 shipped; nightly lane LIVE; S-REL-NIGHTLY-NOTES-001 + S-REL-SPECS-TARBALL-001 COMPLETE (all ACs satisfied). S-REL-CHANGELOG-CHANNEL-SCOPE-001 MATERIALIZED (P1; draft; ADR-063 §D7 amendment pending; BLOCKS v1.0.0 stable). beta.2 NOT YET CUT (human-gated, S-REL-VBUMP-001 territory). story_index v3.033 / total_stories 341.

**HEADS (D-2509 2026-09-09):** develop: `54523dccd` (origin; PR #279 S-REL-SPECS-TARBALL-001 MERGED; specs tarball LIVE); factory-artifacts: run `git -C .factory log -1 --format='%h'` (TD-VSDD-053); main: `bdf24cec8` (stub). Open PRs: PR #255 (OBSOLETE — CLOSE). Dependabot: #265–#274 (UNTRIAGED). WORKTREES REMOVABLE-POST-MERGE: S-REL-NIGHTLY-NOTES-001 (PR #277+#278), S-REL-SPECS-TARBALL-001 (PR #279 @54523dccd), E-REL-NOTES (#264), S-CLAROTY-VULNS-001 (#245), S-ENGINE-LIMIT-EARLY-STOP-001 (#243), S-REL-NIGHTLY-001 (#276). PARKED: S-3.09, W3-FIX-S307-001 (DIRTY), S-ENGINE-H2-LARGE-RESPONSE-001.
...
## D-2513 Checkpoint — ADR-063 §D7 v1.14 AUTHORED; S-REL-CHANGELOG-CHANNEL-SCOPE-001 READY v1.2 — 2026-09-09 (superseded by D-2514)

**RESUME IN ONE BREATH:** Prism at develop@baf720d89 — ADR-063 §D7 v1.14 AUTHORED (per-channel tag-scoping; install mechanism locked to taiki-e/install-action@d438492 git-cliff@2.14.1; tag-ordering invariant concrete). S-REL-CHANGELOG-CHANNEL-SCOPE-001 advanced draft→ready v1.2. DEP D-2509 RESOLVED. NEXT: facade delivery (P1; v1.0.0-stable blocker).
