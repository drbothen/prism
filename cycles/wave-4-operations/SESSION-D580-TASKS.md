...
| 43 | CODIFICATION-CANDIDATE-URGENCY-CRITICAL (SCOPE-EXPANDED) | POL-29 fix-burst-commit-checklist — **8TH OCCURRENCE evidence base (pass-17 D-616 2026-05-16) at NEW phrasing-form dimension; 7TH OCCURRENCE CLOSED by FB15.** POL-25 dispatch-level mandate broke pin-staleness recurrence (PASS at pass-17 FB15-targets) but NOT phrasing-form dimension. POL-29 scope now EXPANDED: must enumerate phrasing-form-canonicalization-on-introduction in addition to version-pin propagation + anchor-syntax. POL-29 is HIGHEST-PRIORITY cycle-close governance policy — permanent codification in policies.yaml required at cycle-close. Mid-cycle dispatch-level mandate does NOT replace permanent codification. | 8 manifestations of BC-2.16.002 citation defect family across 2 dimensions (pin-staleness: FB5/FB6/FB7/FB12/FB13/FB14/FB15; phrasing-form: FB12-era-inherited→pass-17; POL-29 codification STILL NOT CODIFIED; URGENCY CRITICAL at cycle-close — NOT YET CODIFIED; task remains OPEN until cycle-close session-reviewer codifies POL-29 in policies.yaml) |
| 52 | BLOCKED | PREREQ-E fix-burst-16 (1 MED F-LP17-MED-001: 3 story sites phrasing canonicalization no-parens→parens-ancestry form + story v1.10→v1.11 + STORY-INDEX row sync) | Awaiting FB16 dispatch (PO single-burst + state-manager closure) |
| 53 | PENDING | PREREQ-E pass-18 (fresh-context; if CLEAN streak 0/3 → 1/3) | Blocked on Task #52 FB16 completion |
