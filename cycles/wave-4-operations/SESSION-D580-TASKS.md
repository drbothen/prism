...
| 39 | PENDING | PREREQ-E pass-13 (fresh-context; if CLEAN streak 0/3 → 1/3; first fresh-context test after FB11 axis-coverage closure) | Unblocked — FB11 CLOSED |
| 40 | PENDING | If pass-13 CLEAN: streak 0/3 → 1/3 → cascade approaches convergence (pass-14 + pass-15 for 3-CLEAN) | Blocked on Task #39 verdict |
