...
| 43 | CODIFICATION-CANDIDATE-URGENCY-CRITICAL (SCOPE-EXPANDED) | POL-29 fix-burst-commit-checklist — **8 manifestations of BC-2.16.002 citation defect family now ALL CLOSED across 2 dimensions (D-617+D-618 FB16 closed the 8th at phrasing-form dimension; 7TH OCCURRENCE CLOSED by FB15).** POL-29 scope EXPANDED (pass-17 evidence): must enumerate phrasing-form-canonicalization-on-introduction in addition to version-pin propagation + anchor-syntax. POL-29 is HIGHEST-PRIORITY cycle-close governance policy — permanent codification in policies.yaml required at cycle-close. 8-manifestation evidence base COMPLETE. Mid-cycle dispatch-level mandate (POL-25) does NOT replace permanent codification. | 8 manifestations CLOSED: pin-staleness (FB5/FB6/FB7/FB12/FB13/FB14/FB15 across passes 6/7/8/9★/14/15/16) + phrasing-form (FB12-era-inherited→pass-17, CLOSED by FB16). POL-29 codification STILL NOT CODIFIED; URGENCY CRITICAL at cycle-close — NOT YET CODIFIED; task remains OPEN until cycle-close session-reviewer codifies POL-29 in policies.yaml |
...
| 53 | PENDING | PREREQ-E pass-18 (fresh-context; if CLEAN streak 0/3 → 1/3) | Ready to dispatch — FB16 complete |
