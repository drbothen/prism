...
| 51 | PENDING | PREREQ-E pass-17 (fresh-context; if CLEAN streak 0/3 → 1/3) — CRITICAL first test whether POL-25 dispatch-level mandate broke 7-occurrence recurrence pattern (analogous to pass-9 testing FB8 single-bump discipline) | Unblocked by Task #50 FB15 DONE; dispatch when ready |
