...
| 38 | BLOCKED | PREREQ-E fix-burst-11 (1 finding: F-LP12-MED-001 BC-2.16.002 catalog row + BC-2.16.012 cross-ref + EC-016-012-005 event name; Option A production-grade; scope expansion to BC-2.16.002 per Canonical Principle Rule 4) | Awaiting FB11 dispatch |
| 39 | PENDING | PREREQ-E pass-13 (fresh-context; if CLEAN streak 0/3 → 1/3) | Blocked on Task #38 |
