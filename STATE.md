...
factory_artifacts_tech_debt_entries: 56  # All TD-* families (TD-VSDD, TD-W2, TD-W4, TD-S302, TD-S305) per `grep -c "^| TD-"`. VSDD-only count via `grep -c "^| TD-VSDD-"` would be 50. Live pin per POL-11 spirit; was 49 at TD-064 (2026-05-06), now 56 with TD-071 through TD-077 added. .factory/vsdd-plugin-tech-debt.md (TD-VSDD-057 P2 OPEN-DEFERRED-CROSS-REPO; TD-VSDD-058 RESOLVED PR #128 3e858f9f; TD-VSDD-064 P2 proofs_path_canonicalization; TD-VSDD-076 P3 concurrent-test-assertion-strength; TD-VSDD-077 P3 hook-scope-generalization; 56 total — 1 RESOLVED)
...
bc_index_version: "4.41"
vp_index_version: "1.29"
story_index_version: "v2.18"
...
| **Started** | 2026-04-13 |
| **Last Updated** | 2026-05-07 (D-272 — S-3.05 fix-pass-16 sub-burst: error-taxonomy.md E-QUERY-012/013/014 added; BC-2.07.002 v4.4; S-3.05 v1.11 (AC-3/AC-4 + unknown-token AC); BC-INDEX v4.42; STORY-INDEX v2.19; TD-S305-001 filed; D-271 gap closed (prior D-272→D-271 renumber); STATE v7.20→v7.21) |
...
---
## Session Resume Checkpoint (2026-05-07-v7.21-d272-s305-fix-pass-16-sub-burst-error-taxonomy-sync)

_Previous checkpoint (v7.20/D-271/fix-pass-26-combined-p15-p7-closures) archived: [cycles/wave-4-operations/session-checkpoints.md](cycles/wave-4-operations/session-checkpoints.md)_

**STATE v7.21. D-272 — S-3.05 fix-pass-16 sub-burst (error code taxonomy spec sync + D-271 gap closure): error-taxonomy.md E-QUERY-012/013/014 rows added; BC-2.07.002 v4.3→v4.4 (error code refs + unknown-token case); S-3.05 v1.10→v1.11 (AC-3/AC-4 corrected, unknown-token AC note added); BC-INDEX v4.41→v4.42; STORY-INDEX v2.18→v2.19; TD-S305-001 filed (AC-3 clock-injection coverage gap); prior D-272→D-271 renumbered (STATE/HANDOFF/cycle-manifest/vsdd-tech-debt); vsdd-plugin-tech-debt v3.13→v3.14; cycle-manifest v1.73→v1.74; STATE v7.20→v7.21. develop HEAD: 6fefc774. factory-artifacts HEAD: run `git -C .factory log -1 --format='%h %s'`.**
...
**Current spec versions:** BC-2.11.004 v1.4, BC-2.11.005 v1.4, BC-2.11.006 v1.17, BC-2.11.007 v1.4, S-3.02 v1.12, S-3.06 v1.7, BC-INDEX v4.41, STORY-INDEX v2.18, ARCH-INDEX v2.31, VP-INDEX v1.29, prd.md v1.10
