...
2. After PR #129 merged: Tier-2 COMPLETE; dispatch Tier-3 stories (S-3.03/04/05/08/09/11/12/13, 19pts)
3. TD-VSDD-057 codification in vsdd-factory plugin repo (separate session, OPEN-DEFERRED-CROSS-REPO)
4. TD-VSDD-064 follow-up: add proofs_path_canonicalization to policies.yaml + fix S-3.04/S-3.05 path drift
