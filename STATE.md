...
factory_artifacts_tech_debt_entries: 58  # All TD-* families (TD-VSDD, TD-W2, TD-W4, TD-S302, TD-S305) per `grep -c "^| TD-"`. VSDD-only count via `grep -c "^| TD-VSDD-"` would be 51. Live pin per POL-11 spirit; was 49 at TD-064 (2026-05-06), now 58 with TD-070 through TD-078 + TD-S305-001 added (TD-070 closed by POL-11). .factory/vsdd-plugin-tech-debt.md (TD-VSDD-057 P2 OPEN-DEFERRED-CROSS-REPO; TD-VSDD-058 RESOLVED PR #128 3e858f9f; TD-VSDD-064 P2 proofs_path_canonicalization; TD-VSDD-076 P3 concurrent-test-assertion-strength; TD-VSDD-077 P3 hook-scope-generalization; TD-VSDD-078 P3 sub-burst-attribution-convention; 58 total — 1 RESOLVED)
...
| **Started** | 2026-04-13 |
| **Last Updated** | 2026-05-07 (D-273 — S-3.04 pass-8 fix-pass-27: BC-2.07.002 v4.5 Note reconciliation; E-QUERY-013 anchor corrected to BC-2.07.002 §CursorPageSizeInvalid; error-taxonomy v1.15; BC-INDEX v4.43; TD-VSDD-078 filed; LEGACY HISTORICAL sentinel added; count 56→58; STATE v7.21→v7.22) |
...
---
## Session Resume Checkpoint (2026-05-07-v7.22-d273-s304-fix-pass-27-pass8-closures)

_Previous checkpoint (v7.21/D-272/s305-fix-pass-16-sub-burst-error-taxonomy-sync) archived: [cycles/wave-4-operations/session-checkpoints.md](cycles/wave-4-operations/session-checkpoints.md)_

**STATE v7.22. D-273 — S-3.04 pass-8 closures (fix-pass-27): BC-2.07.002 v4.4→v4.5 (Note reconciliation: MCP-cursor surface acknowledged); E-QUERY-013 anchor corrected BC-2.07.001→BC-2.07.002 §CursorPageSizeInvalid; error-taxonomy v1.14→v1.15; BC-INDEX v4.42→v4.43; TD-VSDD-078 filed (sub-burst attribution convention); LEGACY HISTORICAL sentinel added to decisions log; factory_artifacts_tech_debt_entries 56→58; vsdd-plugin-tech-debt v3.14→v3.15; cycle-manifest v1.74→v1.75; STATE v7.21→v7.22. develop HEAD: 6fefc774. factory-artifacts HEAD: run `git -C .factory log -1 --format='%h %s'`.**
