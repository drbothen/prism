...
repos:
  ...
  - ocsf-proto-gen
  - mcp-claroty-xdome
current_step: "D-395 — PR-LEVEL pass-2 CLEAN at HEAD ba7d7f6f. Streak 0/3→1/3 (FIRST CLEAN PASS). Pass-3 at HEAD ba7d7f6f required for streak 2/3."
...
| S-PLUGIN-PREREQ-A LOCAL pass-10 | adversary + state-manager | CLEAN | 0 findings (0C+0H+0M+0L+0OBS); trajectory 14→12→6→4→2→6→4→0→4→0 TRUE CLEAN; streak 0/3→1/3 (resumed after pass-9 reset); Red Gate 6/6 exact names with file:line evidence; workspace sensor_type sweep 26 hits/0 defects CLEAN; 11/11 ACs satisfied; KUDOs 5; STATE v7.123→v7.124 (D-390) |
| S-PLUGIN-PREREQ-A LOCAL pass-11 | adversary + state-manager | CLEAN | 0 findings (0C+0H+0M+0L+0OBS); trajectory 14→12→6→4→2→6→4→0→4→0→0; streak 1/3→2/3; HEAD unchanged from pass-10 (8b949bba) — idempotency confirmed; Red Gate 6/6 exact names (re-derived independently); sensor_type sweep 33 hits/15 files/0 defects; spec coherence confirmed; CI POL-11 satisfied; KUDOs 5; STATE v7.124→v7.125 (D-391) |
