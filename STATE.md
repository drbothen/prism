...
factory_artifacts_tech_debt_entries: 60  # All TD-* families (TD-VSDD, TD-W2, TD-W4, TD-S302, TD-S305) per `grep -c "^| TD-"`. VSDD-only count via `grep -c "^| TD-VSDD-"` would be 53. Live pin per POL-11 spirit; was 49 at TD-064 (2026-05-06), now 60 with TD-070 through TD-080 + TD-S305-001 added (TD-070 closed by POL-11). .factory/vsdd-plugin-tech-debt.md (TD-VSDD-057 P2 OPEN-DEFERRED-CROSS-REPO; TD-VSDD-058 RESOLVED PR #128 3e858f9f; TD-VSDD-064 P2 proofs_path_canonicalization; TD-VSDD-076 P3 concurrent-test-assertion-strength; TD-VSDD-077 P3 hook-scope-generalization; TD-VSDD-078 P3 sub-burst-attribution-convention; TD-VSDD-079 P3 BC-line-number-citation-lint; TD-VSDD-080 P3 broken-section-anchor-lint; 60 total — 1 RESOLVED)
...
| **Started** | 2026-04-13 |
| **Last Updated** | 2026-05-07 (D-276 — S-3.04 pass-11 fix-pass-30: BC-2.07.002 v4.8 broken anchor fix (§Concurrent Fetch Limits suffix drop); STORY-INDEX v2.20/19/18 reorder ascending→v2.21; TD-075 10→11 violations + prose math corrected; TD-S305-001 cross-ref v4.8/v1.12; vsdd-tech-debt timestamp 15Z→17Z; BC-INDEX v4.46; cycle-manifest v1.78; STATE v7.24→v7.25) |
