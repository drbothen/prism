...
// ─── DEFECT-PQL-FNCALL-LHS-001 BC-2.11.019 v1.24 §OBS-005: ParseError ─────────
//
...
/// (BC-2.11.019 v1.24 §OBS-005). External callers MUST use `ParseError::new(...)`
...
///
/// Added: DEFECT-PQL-FNCALL-LHS-001 fix-burst-42 (BC-2.11.019 v1.24 §OBS-005).
/// ci.yml EXPECTED bumped from 91 to 92.
#[allow(dead_code)]
