...
/// serve CVE-stamped device records enabling the NVD pivot (AC-008 / BC-2.06.019 v1.11,
/// F-PIVOT003-R2-002).
///
...
async fn test_BC_2_06_019_scenario_clone_device_records_carry_device_cves_first() {
    ...
    assert!(
        ...
        "build_scenario_entity_catalog must produce a non-empty device_cves slice; \
         got empty. BC-2.06.019 v1.11 F-PIVOT003-R2-002."
    );
...
/// present at stage 4.
///
/// BC-2.06.019 v1.11 PC-4: "device_cves=false: CVE-related enrichment fields on device
...
async fn test_BC_2_06_019_armis_device_cves_first_stagemask_served_route() {
    ...
    assert!(
        ...
        "F-PIVOT003-R7A-001 BC-2.06.019 v1.11 PC-4: at stage 1 (Recon, mask.device_cves=false), \
    ...
    assert!(
        ...
        "F-PIVOT003-R7A-001 BC-2.06.019 v1.11 PC-4: at stage 4 (Containment, \
...
///
/// BC-2.06.019 v1.11 PC-4 / F-PIVOT003-R8C-001: the `device_cves_first` strip must be
...
async fn test_F_PIVOT003_R8C_001_search_device_cves_first_stagemask_served_route() {
    ...
    assert!(
        ...
        "F-PIVOT003-R8C-001 / BC-2.06.019 v1.11 PC-4: at stage 1 (Recon, mask.device_cves=false), \
    ...
    assert!(
        ...
        "F-PIVOT003-R8C-001 / BC-2.06.019 v1.11 PC-4: at stage 4 (Containment, mask.device_cves=true), \
