...
pub fn prism_error_to_structured_call_result(err: PrismError) -> rmcp::model::CallToolResult {
    ...
    let meta = match &err {
        ...
        // it were a callable per-field UDF name (e.g. `threat_score`).
        //
        // HIGH-2 fix (BC-2.11.019 v1.4 §MCP surface): bind the boxed details (ref d) to
        ...
        //
        // Suggestion text per BC-2.11.019 v1.4 §MCP surface (NO brackets around list):
        ...
        //
        // Reference: S-DEMO-FIDELITY-REMEDIATION-001 AC-N1B HIGH-2; BC-2.11.019 v1.4;
        ...
        PrismError::EnrichUdfNotFound(ref d) => {
            ...
            VariantMeta {
                ...
                how_to_fix: None,
                available_columns: None,
                // BC-2.11.019 v1.4: did_you_mean is the best-match infusion name (Option<String>).
...
mod tests {
    ...
    // ── HIGH-2: BC-2.11.019 v1.4 AC-N1B — E-QUERY-039 structured payload ────────────

    /// BC-2.11.019 v1.4 AC-N1B HIGH-2 — `prism_error_to_structured_call_result` structured
    ...
    /// BC-2.11.019 v1.4 AC-N1B HIGH-2 — empty available_infusions suggestion form.
    ///
