...
//! | AC-002 | Cross-org spoofing returns HTTP 401 (W3-FIX-SEC-001; BC-3.5.002 postcondition 2) |
...
//! | AC-005 | Regression: `test_cross_org_header_rejected` (W3-FIX-SEC-001; BC-3.5.002 postcondition 2) |
...
// ===========================================================================
// AC-002 — Cross-org spoofing returns 401 (W3-FIX-SEC-001; BC-3.5.002 postcondition 2)
// ===========================================================================

/// AC-002 / W3-FIX-SEC-001 (BC-3.5.002 postcondition 2):
...
///
/// Traces to: W3-FIX-SEC-001 AC-002; BC-3.5.002 postcondition 2.
#[tokio::test]
