...
//! Traces to:
//!   BC-2.06.019 v1.10 PC-4 — CrowdStrike detections IOC stamp in behaviors[] array
...
/// Test 6 — BC-2.06.019 v1.10 PC-4 + SAP-2: the CrowdStrike sensor TOML spec must
...
///
/// BC-2.06.019 v1.10 PC-4, AC-005, SAP-2.
