...
//! Traces to:
//!   BC-2.06.019 v1.11 PC-4 — CrowdStrike detections IOC stamp in behaviors[] array
...
/// Test 6 — BC-2.06.019 v1.11 PC-4 + SAP-2: the CrowdStrike sensor TOML spec must
...
///
/// BC-2.06.019 v1.11 PC-4, AC-005, SAP-2.
    ...
    for toml_path in &toml_paths {
        ...
        for col in &required_columns {
            assert!(
                ...
                "BC-2.06.019 v1.11 PC-4 / AC-005 / SAP-2: crowdstrike.sensor.toml at {:?} \
