...
//! RG-09 / HS-018: BC-2.16.001 v1.5 — Sensor spec_id / Filename Mismatch Rejected
//!
...
/// RG-09 / HS-018 / BC-2.16.001 v1.5 §Error Conditions E-SPEC-017:
...
"#,
    ...
    // has the filename context required to detect the mismatch (BC-2.16.001 v1.5 §Error Conditions).
