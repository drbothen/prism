...
pub enum Literal {
    ...
    /// Validated at plan time by `check_temporal_literals_opt_a` (three-way dispatch).
...
impl PqlNormalizer {
    ...
    fn normalize_literal(lit: &Literal) -> String {
        match lit {
            ...
            // check_temporal_literals_opt_a consumes RawTemporalLiteral before normalization.
