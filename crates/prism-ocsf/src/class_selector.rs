...
//! table. Per BC-2.02.012 v1.4 INV-NO-2001-SELECT-PATH, `select()` MUST NOT return
...
//! | Security Finding (DEPRECATED) | 2001  | NOT used in `select()` or `select_by_class_name()` — deprecated OCSF v1.1.0. `select_by_class_name("security_finding")` returns 2004 with a deprecation WARN (BC-2.02.012 v1.4 Option A, OCSF-CLASS-MIGRATION-001). |
//!
//! ## `select_by_class_name(class_name)` path mappings (BC-2.02.012 v1.4)
//!
...
///
/// **NOT used by `select_by_class_name("security_finding")`** — per BC-2.02.012 v1.4
...
///
/// Per INV-NO-2001-SELECT-PATH and INV-PRODUCTION-TOML-NO-SECURITY-FINDING (BC-2.02.012 v1.4):
...
impl EventClassSelector {
    ...
    ///
    /// # Mappings (BC-2.02.012 v1.4, OCSF-CLASS-MIGRATION-001 Option A)
    ///
