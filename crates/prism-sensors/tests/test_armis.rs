//! Armis adapter integration tests — superseded by spec-catalog dispatch parity tests.
//!
//! As of PLUGIN-MIGRATION-001-A (AC-003, AC-006), the `ArmisAdapter` and `ArmisAuth`
...
//!
//! Story: PLUGIN-MIGRATION-001-A | BC: BC-2.01.008, BC-2.01.013, BC-2.01.016
