# Cyberint Parity Reference OCSF Fixtures

Fixtures not yet recorded — parity tests are tagged `#[ignore]` until
DTU clone story S-6.09 merges.

## Recording Procedure (ADR-028 §D3)

1. Start Cyberint DTU clone server
2. Run legacy `CyberintAdapter::fetch()` against DTU clone for alerts table
...
- Note: incidents table parity is explicit SKIP (EC-016-013-002), no fixture needed
