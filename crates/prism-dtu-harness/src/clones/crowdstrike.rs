// ADR-023 §DTU-EXEMPT: This file IS the DTU behavioral clone for CrowdStrike.
...
// Imports from deleted prism-sensors::auth::crowdstrike modules (001-A) verified absent.
