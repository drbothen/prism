...
// ---------------------------------------------------------------------------
// Tests — W3-FIX-SEC-001 org-isolation guard for list_devices endpoint
//
// AC-007: list_devices enforces the same X-Org-Id org-isolation guard as
// list_alerts and list_audit_logs.
//
// AC traces:
//   test_W3_FIX_SEC_001_claroty_devices_org_mismatch_returns_401     → org-mismatch 401, non-nil clone
//   test_W3_FIX_SEC_001_claroty_devices_nil_org_no_header_returns_200 → nil-org backward-compat
// ---------------------------------------------------------------------------
#[cfg(test)]
...
mod tests {
    ...
    /// W3-FIX-SEC-001 — org-isolation guard for list_devices (non-nil clone, mismatched org).
    ///
    ...
    #[tokio::test]
    async fn test_W3_FIX_SEC_001_claroty_devices_org_mismatch_returns_401() {
    ...
    #[tokio::test]
    async fn test_W3_FIX_SEC_001_claroty_devices_nil_org_no_header_returns_200() {
