...
//! | RG-009 / AC-005/EC-009 | test_BC_2_16_016_claroty_ot_activity_events_raw_toml_name_detection_time_raises_e_query_038 | E-QUERY-038 when querying raw TOML name `detection_time` (projected as Arrow name `time` under ocsf_column_naming=true) — F-COE1-P1-OBS-001 closure |
