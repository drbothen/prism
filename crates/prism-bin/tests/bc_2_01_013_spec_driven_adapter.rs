...
//! `class_uid = 2004`, `category_uid = 2` (2004/1000). Per BC-2.02.012 v1.4 Option A,
...
/// OCSF-CLASS-MIGRATION-001). Per BC-2.02.012 v1.4 Option A transitional alias:
...
fn make_crowdstrike_detection_spec(base_url: &str) -> SensorSpec {
    SensorSpec::new(
        ...
        vec![TableSpec::new_point_in_time(
            "detections",
            "security_finding", // ocsf_class transitional alias per BC-2.02.012 v1.4 Option A; select_by_class_name → 2004, category_uid 2
            vec![
...
/// (transitional alias per BC-2.02.012 v1.4 Option A; OCSF-CLASS-MIGRATION-001).
/// `EventClassSelector::select_by_class_name("security_finding")` → 2004 (Detection Finding).
...
/// 2004 (per BC-2.02.012 v1.4 Option A) — the full derivation chain produces class_uid = 2004.
///
...
async fn test_BC_2_01_013_ocsf_conformance_envelope_derived_not_raw_copied() {
    // select_by_class_name("security_finding") → 2004 (BC-2.02.012 v1.4 Option A,
    ...
    assert_ne!(
        ...
        "F-001-R item 2 LOAD-BEARING: class_uid in returned RecordBatch MUST NOT be the \
         ...
         (BC-2.02.012 v1.4 Option A transitional alias — Detection Finding, not deprecated 2001). \
    ...
    // BC-2.02.012 v1.4 mapping: ocsf_class "security_finding" → class_uid 2004 (transitional alias),
    ...
    assert_eq!(
        ...
        "F-001-R item 2 LOAD-BEARING: class_uid MUST equal the spec-derived value 2004 \
         ...
         Per BC-2.02.012 v1.4 Option A (OCSF-CLASS-MIGRATION-001), 'security_finding' is a \
