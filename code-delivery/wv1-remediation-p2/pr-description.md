...
```mermaid
graph LR
    PASS1[Wave 1 Gate Remediation PR 30<br/>merged to develop] --> THIS[fix/wave-1-gate-pass-2<br/>this PR]
    FACTARTS[factory-artifacts SHA 4eba02a2<br/>5 state findings resolved] --> THIS
...
flowchart LR
    ...
    AC_H001 --> T_H001[serial annotation on 3 tests]
    T_H001 --> Code_H001[7bfea632: serial_test dep + serial attr]
