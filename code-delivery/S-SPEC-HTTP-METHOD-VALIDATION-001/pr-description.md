...
| BC-2.16.009 | v1.10 | §Validation Rules 7 — 32-codepoint echo cap (SEC-001/CWE-400) | AC-004 | `test_BC_2_16_009_sec_001_overlong_method_truncated_in_error` |
| BC-2.16.009 | v1.10 | §VR7 §Ordering Point 3 — full-match skip-guard (F-PR1-OBS-001) | AC-005 | `test_BC_2_16_009_f_pr1_obs_001_partial_token_embedding_not_skipped` |
...
- [x] Traceability chain complete: BC-2.16.009 v1.10 → AC-001/002/003/004/005 → Red Gate tests → `validate_step_methods()` implementation
