...
**Expected Outcome:**
- The file is rejected with `E-SPEC-017` per error-taxonomy.md v1.42 (filename-stem-vs-sensor_id
...
- `E-SPEC-017` returned per error-taxonomy.md v1.42 (case-mismatch is a filename-stem-vs-sensor_id failure, not a duplicate-sensor_id; E-SPEC-009 does not apply here)
