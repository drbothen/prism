...
Story-level holdout gate for DEFECT-CLAROTY-SORTBY-DETERMINISM-001 (7-table sort_by fix — vulnerabilities, audit_logs, server_interfaces, organization_zones, zone_policies, firewall_groups, firewall_policies; TOML-only change to body_template strings; BCs: BC-2.16.015 v2.0, BC-2.16.013 v1.43, BC-2.16.019 v1.3, BC-2.16.020 v1.3, BC-2.16.021 v1.3). HIDDEN from test-writer and implementer. SINGLE-USE. Evaluates against `crates/prism-sensors/specs/claroty.sensor.toml` (data artifact) + Claroty DTU MCP smoke queries (prism-dtu-claroty). SAP-2 N/A (request-body fields; no response-shape impact per story Task 9). All 4 scenarios must_pass P0.
