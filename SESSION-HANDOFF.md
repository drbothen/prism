...
successor_focus: "## NEXT ACTION (D-429 — S-PLUGIN-PREREQ-C STORY READY)\n\nDispatch test-writer for S-PLUGIN-PREREQ-C Red Gate stubs per per-story-delivery step b. Story spec at /Users/jmagady/Dev/prism/.factory/stories/S-PLUGIN-PREREQ-C-toml-grammar-extensions-plus-pub-api-hardening.md (728 lines, 7 ACs, v1.0 ready). Test-writer must: (1) create one Red Gate test per AC (7 tests); (2) anchor tests in appropriate crate (prism-spec-engine for AC-1/2/3/4/5; prism-core for AC-6/7); (3) ensure tests COMPILE but FAIL (red); (4) commit stubs as one atomic .factory/ + workspace commit. Anti-volatile-pin: test names should be `test_AC_N_descriptive_name` not file:line citations. Pin SHAs at D-429: develop@ae7e26c8 | factory-artifacts: run `git -C .factory log -1 --format='%H'` (per TD-VSDD-053) | BC-2.16.002 v1.9 active | Story v1.0 ready.\n\n**PREREQ-C ACs (7):**\n1. AC-1 (TD-B-001 P2): CursorToken page_size — PaginationConfig::CursorToken adds page_size: Option<u32>; build_paged_url() appends parameter to BOTH first-call and cursor-continuation URLs when set.\n2. AC-2 (TD-B-003 P3): extract_at_path bracket notation $.x[0] (array indexing) AND wildcards $.x[*] (array enumeration).\n3. AC-3 (TD-B-006 P2): proptest fixtures for fan_out_batches, extract_at_path, Interpolator::interpolate, Interpolator::extract_references.\n4. AC-4 (TD-B-008 P3): ${...} literal escape mechanism ($${...} -> literal ${...}).\n5. AC-5 (TD-B-016 P2): #[non_exhaustive] applied to ALL pub TOML-deserialized types in prism-spec-engine.\n6. AC-6 (TD-A-006 P3): cross-newtype audit of pub-API validation-bypass entry points in prism-core.\n7. AC-7 (TD-A-008 P3): re-export SensorIdValidationError at prism_core crate root.\n\n**Spec versions at D-429:** Story S-PLUGIN-PREREQ-C v1.0 (status: ready), BC-2.16.002 v1.9 (active), BC-2.01.013 v1.6 (active), STORY-INDEX v2.62, BC-INDEX v4.60, VP-INDEX v1.32, develop@ae7e26c8. STATE v7.163 SESSION-HANDOFF v7.163 (current).\n\n**Previous action (D-428 PRE-COMPACT CHECKPOINT) — COMPLETE:** story-writer dispatched and delivered S-PLUGIN-PREREQ-C spec. Original dispatch context preserved in predecessor_session field above."

**CURRENT STATE (2026-05-12, D-429 — S-PLUGIN-PREREQ-C STORY READY)**
...
- STATE.md / SESSION-HANDOFF: v7.162 → v7.163

**D-429 — S-PLUGIN-PREREQ-C story-writer COMPLETE. Story v1.0 status:ready.**
- Story at: /Users/jmagady/Dev/prism/.factory/stories/S-PLUGIN-PREREQ-C-toml-grammar-extensions-plus-pub-api-hardening.md (728 lines)
- 7 ACs from D-428 TD scope: TD-B-001/003/006/008/016 + TD-A-006/008
- AC-8 (TD-A-007 P3 length-before-charset) deferred — non-blocking at PRISM_MAX_QUERY_SIZE=65_536
- NEXT: dispatch test-writer for Red Gate stubs (per-story-delivery step b)
