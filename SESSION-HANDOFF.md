...
>
> **PRIORITY READ ORDER:** Read §ACTIVE OBJECTIVE (North Star) FIRST, then **D-1687 PR-LEVEL pass 1 CLEAN(PR-merge) 2+2 findings fixed; security CLEAR; @912e862d PUSHED; streak 0/3; PR-LEVEL pass 2 IN FLIGHT on FROZEN @912e862d; HUMAN MERGE APPROVAL REQUIRED after PR-LEVEL 3-CLEAN** (STATE.md frontmatter is authoritative; D-1681 §RESUME SNAPSHOT below is the most recent durable SESSION WRAP snapshot).
...
> develop HEAD origin/develop `b9cf3f9b` (PR #220 DEFECT-EQUERY042-GROUPBY-DEADARM-001 squash-merged 2026-07-10). factory-artifacts HEAD: run `git -C .factory log -1 --format='%h %s'` (do not hard-code). STATE v8.287. D-1687 (PR-LEVEL pass 1 CLEAN(PR-merge) 2+2 findings fixed; security CLEAR; @912e862d PUSHED; streak 0/3; pass 2 in progress on FROZEN @912e862d; HUMAN MERGE APPROVAL REQUIRED after PR-LEVEL 3-CLEAN).
