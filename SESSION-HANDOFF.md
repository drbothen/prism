...
**NEXT ACTION:**
S-PLUGIN-PREREQ-A LOCAL pass-4 BLOCKED-soft (D-384). Dispatch implementer fix-burst-4 against feature/S-PLUGIN-PREREQ-A@17b723e2: (1) add leading-letter constraint to validate_sensor_id_string in prism-core (align with prism-spec-engine ^[a-z][a-z0-9_-]*$); (2) rename get_all_for_sensor_type → get_all_for_sensor_name per task 7; (3) rename sensor_type_from_source_ref / sensor_type_from_table_name private fns; (4) add doc-comment to SensorAdapter::sensor_type citing task-5 hold; (5) update validate_sensor_id_string doc-comment to reflect pub(crate); (6) file behavioral consistency TD for EXPLAIN silent-skip vs E-QUERY-031. After fix-burst-4 commits, dispatch adversary pass-5 fresh-context."
---
