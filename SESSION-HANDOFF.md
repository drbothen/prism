...
**NEXT ACTION:**
Orchestrator-user decision needed: (a) PREREQ-D (PluginRuntime + .prx loader infrastructure + PR template — gates PREREQ-E + Wave 1/A WASM enforcement), or (b) PREREQ-A (SensorId open-newtype + SensorType deletion — gates Wave 1/B sensor-spec validation work). User decision required before dispatch."
---
