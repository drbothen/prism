...
>
> **PRIORITY READ ORDER:** Read §ACTIVE OBJECTIVE (North Star) FIRST, then **D-1688 PR-LEVEL passes 2+3 CLEAN(strict)=YES on frozen 912e862d; streak 2/3; pass 4 IN FLIGHT; HUMAN MERGE APPROVAL REQUIRED after PR-LEVEL 3-CLEAN** (STATE.md frontmatter is authoritative; D-1681 §RESUME SNAPSHOT below is the most recent durable SESSION WRAP snapshot).
