...
predecessor_session: "**W3-FIX-G COMPLETE** 2026-05-01. 36 story status flips, 37+3 STORY-INDEX MERGED annotations, SS-00→[], cycle-manifest closed, BC-INDEX pin v4.17→v4.26. STATE v6.04→v6.05. Stage1: eea8a03b. develop HEAD: a3bd5a0f."
...
factory Stage 1: eea8a03b. develop HEAD: a3bd5a0f."
---
...
develop HEAD `a3bd5a0f` | factory-artifacts `eea8a03b` (Stage 1 — W3-FIX-G burst 2026-05-01)

| Metric | Value |
|--------|-------|
| develop HEAD | `a3bd5a0f` (W3-FIX-CI-001 — cargo-nextest + mold CI, PR #112, 2026-04-30) |
| factory-artifacts HEAD | `eea8a03b` (Stage 1 — W3-FIX-G state hygiene burst canonical) |
| PR count merged | 112 |
