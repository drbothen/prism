...
**NEXT ACTION:**
S-PLUGIN-PREREQ-A LOCAL pass-5 BLOCKED-soft (D-385). Dispatch implementer fix-burst-5 against feature/S-PLUGIN-PREREQ-A (post-fix-burst-4 SHA): (1) rename sensor_type_to_string → sensor_name_to_string at virtual_fields.rs:154-165 and call site :74 (closes F-LP5-MED-001); (2) optional: add #[non_exhaustive] to SensorIdValidationError (OBS-LP5-002); (3) git add .proptest-regressions if untracked (OBS-LP5-001). After fix-burst-5 commits, dispatch adversary pass-6 fresh-context — expected CLEAN (streak 0/3 → 1/3)."
---
