...
successor_focus: "PRE-COMPACT CHECKPOINT (D-377) — state durable at develop c6dd6602 / factory-artifacts 07423865 / STATE+HANDOFF v7.111. POST-COMPACT FIRST ACTION: Dispatch product-owner for Wave 0/F (PLUGIN-PREREQ-F) BC + DI catalog amendments per ADR-023 v1.17 PREREQ-F scope. Scope: (1) Deprecate BC-2.16.004 (rust-escape-hatch); (2) Amend BC-2.01.013 (datasource-trait-adapter-pattern); (3) Amend DI-012 — downgrade compile-time to runtime + 3 auth-composition rejection rules per F-CRIT-002; (4) Sweep 8 sensor-named BCs (BC-2.01.005-008 + BC-2.02.003-006). Edit/Write tools ONLY per TD-FACTORY-HOOK-BYPASS-001 P0."

**PRE-COMPACT CHECKPOINT (2026-05-10)**

**Pin SHAs:**
- develop HEAD: c6dd6602 (PR #141 S-3.02-FOLLOWUP-RUNTIME merged 2026-05-10)
- factory-artifacts HEAD: 07423865 (cycle reflection + 4 methodology TDs)
- STATE.md / SESSION-HANDOFF: v7.111
- ADR-023: v1.17 (SUBSTANTIVE CONVERGENCE DECLARED — D-375)

**Plugin migration status:**
- ADR-023 v1.17 substantive content CLEAN since pass-19 (6 stable passes)
- 25 adversary passes + 20 fix-bursts complete
- Substantive convergence declared by user 2026-05-10 (D-375); full 3-CLEAN at max rigor not pursued due to agent-ecosystem drift rate observation
- Cycle reflection at .factory/cycles/wave-4-operations/adr-023-cycle-reflection.md (332 lines)

**Methodology TDs filed (open, cross-repo/plugin work):**
...
- D-214..D-320 LOST from STATE.md (fix-burst-17 compaction discarded without archiving); recovery via git history pre-`f243867f` documented in STATE.md L219 archive note + TD-VSDD-058

**Bundle B Phase B-2 status:**
- BLOCKED on plugin migration (5 stories pending: W3-FIX-S307-001, W3-FIX-S307-002, S-1.12-FOLLOWUP, S-1.14-REDO, S-5.01-FOLLOWUP-MCP-BOOT)
- Worktree feature/W3-FIX-S307-001@fcab8717 retained inactive at .worktrees/W3-FIX-S307-001/
- All 5 stories will re-scope after PLUGIN-MIGRATION-001 Wave 0+1 ship
...
- Per TD-VSDD-060: sibling-site sweep on every value change (ADR version bump → frontmatter + Status block + Status-as-of + ARCH-INDEX row + STATE.md spec-versions + SESSION-HANDOFF spec-versions)
- TD-FACTORY-HOOK-BYPASS-001 P0 policy: any bash/Python file-write in .factory/ is forbidden

**POST-COMPACT FIRST ACTION:**

Dispatch product-owner for Wave 0/F (PLUGIN-PREREQ-F) BC + DI catalog amendments per ADR-023 v1.17 PREREQ-F scope. Read `.factory/specs/architecture/decisions/ADR-023-plugin-only-sensor-architecture.md` v1.17 PREREQ-F section first (around lines 480-500 area; verify in file). Scope:
(1) Deprecate BC-2.16.004 (rust-escape-hatch) — set lifecycle_status: deprecated, add deprecated_by: ADR-023, body deprecation note retiring CustomAdapter trait
(2) Amend BC-2.01.013 (datasource-trait-adapter-pattern) — un-seal SensorAuth runtime-validation rules, spec-driven adapter pattern
(3) Amend DI-012 in invariants.md — downgrade compile-time to runtime; document 3 cross-sensor auth-composition rejection rules per ADR-023 F-CRIT-002 close (auth_type single value; credential_refs single per method; credential type structurally matches auth_type)
(4) Sweep 8 sensor-named BCs (BC-2.01.005-008 + BC-2.02.003-006) — add prefix note pointing to ADR-023; full amendment lands in Wave 2/G
Edit/Write tools ONLY. Single-commit-per-burst. Verify every claim post-commit."
---
