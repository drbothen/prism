...
**NEXT ACTION:**
S-PLUGIN-PREREQ-A LOCAL pass-6 BLOCKED-soft (D-386). Dispatch implementer fix-burst-6 against feature/S-PLUGIN-PREREQ-A (post-fix-burst-5 SHA bcf2f717): (1) F-LP6-HIGH-001: validate SensorId::new() or rename new_unchecked + add new_validated() at sensor_id.rs:47-52; (2) F-LP6-MED-001: standardize test stub mock SensorAdapter field names sensor_type→sensor_id across prism-sensors/src/tests/ + prism-query/tests/; (3) F-LP6-MED-003: extend proptest strategy to non-ASCII rejection class + hardcoded test vector validate_sensor_id_string("crowdstr\u{00EF}ke"); (4) F-LP6-MED-004: change get_all_for_sensor_name to accept impl Borrow<str> or &str; update fanout.rs:337+490; (5) F-LP6-LOW-001: change pub→pub(crate) on validate_sensor_id_string. MED-002 + LOW-002 already resolved by state-manager this burst. After fix-burst-6 commits, dispatch adversary pass-7 fresh-context."
---
