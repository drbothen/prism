...
>
> **PRIORITY READ ORDER:** Read §ACTIVE OBJECTIVE (North Star) FIRST, then **D-1671 STATE BURST; CSDEVICES streak 0/3 on frozen 4f084a31; VERY NEXT = LOCAL pass 23** (above; current state). STATE.md frontmatter (`develop_head`, `current_step`) is authoritative.
> **SOURCE-OF-TRUTH FOR CURRENT PIPELINE POSITION:** D-1671 bullet above + STATE.md frontmatter. §RESUME SNAPSHOT D-1666 below is the most recent durable SESSION WRAP snapshot. `.factory/objectives/DEMO-SCOPE.md` is the demo SCOPE/NARRATIVE reference — not the live pipeline tracker.
> develop HEAD origin/develop `b9cf3f9b` (PR #220 DEFECT-EQUERY042-GROUPBY-DEADARM-001 squash-merged 2026-07-10). factory-artifacts HEAD: run `git -C .factory log -1 --format='%h %s'` (do not hard-code). STATE v8.271. D-1671 (STATE BURST; CSDEVICES 22-pass cascade; streak 0/3 on frozen 4f084a31; pass-22 5 findings closed: 1 MED + 3 LOW + 1 OBS; BC-2.11.005 v1.11 + BC-2.11.012 v1.11 + BC-2.16.002 v2.10; CWE-117 SQL-field sweep; POL-22 two-sided lesson; EQUERY042 CLOSED).
