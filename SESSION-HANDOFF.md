...
**NEXT ACTION:**
S-PLUGIN-PREREQ-A fix-burst-1 in flight. Implementer targeting all 14 findings in severity order (2 CRITICAL first: unknown-table regression + AC-6 perimeter compile-fail). After fix-burst-1 lands, dispatch pass-2 fresh-context."
---
