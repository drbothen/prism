...
**KEY REFERENCES:**
- STATE.md v7.94: D-343 ADR-023 pass-10 NOT_CLEAN streak RESET 0/3; develop@c6dd6602; factory-artifacts HEAD: run git -C .factory log -1 (TD-VSDD-053)
...
develop HEAD: c6dd6602. ADR-023 at v1.7 streak RESET 0/3. NEXT: fix-burst-8 (architect, wording-only → v1.8) then pass-11. factory-artifacts HEAD: run git -C .factory log -1 per TD-VSDD-053."
---
