...
- STATE.md / SESSION-HANDOFF: v7.177 → v7.178
...
- Cycle resolution: STORY-INDEX 001-D depends_on has stale 001-A entry (data error — fix before Wave 1)
...
- Two inconsistencies flagged for Step 2: STORY-INDEX:397 001-D→001-A cycle + PREREQ-C adv-review path drift
- **STEP 2 (maintenance burst) is next. STORY-INDEX:397 fix is gating STEP 3.**
