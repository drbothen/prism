...
develop HEAD `37c620f7` | factory-artifacts HEAD `ccbdd555` (pre-fix) → Stage 1 `7f1f5b01` → Stage 2 this commit (canonical — Pass 25 fix burst)

| Metric | Value |
|--------|-------|
| develop HEAD | `37c620f7` (Wave 2 final — no Wave 3 commits yet) |
| factory-artifacts HEAD | `ccbdd555` pre-fix → Stage 1 `7f1f5b01` → Stage 2 this commit (canonical) |
| PR count merged | 72 |
