...
develop HEAD `ba3b10c7` | factory-artifacts `618b453e` (W4 Phase 4.A Pass 1 remediation — 6 ADRs v0.2 + 8 stories aligned; Stage 1; STATE v6.27 backfill in progress)
...
1. **Adversarial Pass 2 (vsdd-factory:adversary):** re-run on remediated specs (6 ADRs at v0.2 + 8 stories aligned). Target: CLEAN to open convergence window 1/3.
