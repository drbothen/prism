...
>
> **PRIORITY READ ORDER:** Read §ACTIVE OBJECTIVE (North Star) FIRST, then **D-1670 STATE BURST; CSDEVICES streak 0/3 on frozen e1a00fa3; VERY NEXT = LOCAL pass 22** (above; current state). STATE.md frontmatter (`develop_head`, `current_step`) is authoritative.
> **SOURCE-OF-TRUTH FOR CURRENT PIPELINE POSITION:** D-1670 bullet above + STATE.md frontmatter. §RESUME SNAPSHOT D-1666 below is the most recent durable SESSION WRAP snapshot. `.factory/objectives/DEMO-SCOPE.md` is the demo SCOPE/NARRATIVE reference — not the live pipeline tracker.
> develop HEAD origin/develop `b9cf3f9b` (PR #220 DEFECT-EQUERY042-GROUPBY-DEADARM-001 squash-merged 2026-07-10). factory-artifacts HEAD: run `git -C .factory log -1 --format='%h %s'` (do not hard-code). STATE v8.270. D-1670 (STATE BURST; CSDEVICES 21-pass cascade; streak 0/3 on frozen e1a00fa3; pass-21 3 findings closed: 2 LOW + 1 OBS; BC-2.11.012 v1.10 two-stage POL-22; DRIFT-INTERNAL-TABLE-COLUMN-GATE-001; EQUERY042 CLOSED).
