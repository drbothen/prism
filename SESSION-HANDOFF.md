...
**NEXT ACTION:**
S-PLUGIN-PREREQ-A LOCAL pass-3 BLOCKED-hard (D-383). Dispatch implementer fix-burst-3 against feature/S-PLUGIN-PREREQ-A@9578f574: (1) sensor_id.rs:248-256 doc rewrite; (2) Provenance.sensor_type→sensor_name DTU rename (11 sites); (3) E-QUERY-031 unit test; (4) explain.rs:1304 metadata key; (5) validate_sensor_id_string pub→pub(crate). After fix-burst-3 commits, dispatch adversary pass-4 fresh-context."
---
