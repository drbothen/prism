...
| BC-2.17.005 | CAP-030, CAP-032 | 17 - WASM Plugin Runtime | P0 |
...
Regenerated from BC file `capability:` frontmatter fields (Burst 13 Part B, updated Burst 21 Task A, 2026-04-17; CAP-035 re-anchor pass-80 follow-on). CAP titles are canonical from `domain-spec/capabilities.md`. Grand total column sum = 207 (200 active BCs + 7 active dual-anchor extras). Dual-anchor BCs (7 active = BC-2.01.010, BC-2.10.002, BC-2.10.005, BC-2.10.008, BC-2.16.008, BC-2.17.005, BC-2.19.004) are each counted once under each anchored CAP in the summary.
...
| CAP-032 | WASM Plugin Runtime | 6 | BC-2.17.001/002/003/004/005/006 |
