...
introduced: cycle-1
modified: ["cycle-1-burst-45", "cycle-1-burst-49", "pass-69-housekeeping", "pass-73-fix", "pass-79-fix", "F-S503-002-adjudication-2026-06-17", "S-5.03-org-no-overlay-semantics-2026-06-17", "RECONCILIATION-1-clients-shape-2026-06-17"]
deprecated: null
deprecated_by: null
replacement: null
retired: null
...
|-------|----------------|----------|
| Read `prism://config/clients` with two clients ("acme", "globex") configured | JSON array with two `ClientInventoryEntry` objects, each containing `client_id`, `sensor_count`, `enabled_sensors` | happy-path |
