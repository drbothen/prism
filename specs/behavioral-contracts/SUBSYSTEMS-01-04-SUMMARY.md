...
This subsystem is the sensor adapter layer that the query engine (subsystem 11) calls. Per-sensor MCP read tools have been removed -- all data access goes through the `query` tool (CAP-015).

| ID | Title | Capability | Priority | Status |
|----|-------|-----------|----------|--------|
| BC-2.01.001 | ~~Single-Client Sensor Query Returns Scoped Results~~ | CAP-001 | P0 | removed |
| BC-2.01.002 | Cross-Client Fan-Out — Query Engine Orchestrates Parallel Sensor Fetches | CAP-002 | P0 | draft |
| BC-2.01.003 | ~~Cursor-Based Forward-Only Pagination (MCP-Exposed)~~ | CAP-001 | P0 | removed |
| BC-2.01.004 | Offset-Based Hybrid Pagination for Claroty Audit Logs | CAP-001 | P0 | draft |
| BC-2.01.005 | CrowdStrike OAuth2 Authentication and Two-Step Fetch | CAP-001 | P0 | draft |
| BC-2.01.006 | Cyberint Cookie-Based Authentication and Multi-Format Timestamp Parsing | CAP-001 | P0 | draft |
| BC-2.01.007 | Claroty Bearer Token Auth with Polymorphic ID Handling | CAP-001 | P0 | draft |
| BC-2.01.008 | Armis Bearer Token Auth with AQL Query Forwarding and Timestamp Fallback | CAP-001 | P0 | draft |
| BC-2.01.009 | ~~Query Filtering and Sorting Parameters~~ | CAP-001 | P0 | removed |
| BC-2.01.010 | Partial Failure Handling for Paginated and Cross-Client Queries | CAP-001, CAP-002 | P0 | draft |
| BC-2.01.011 | ~~Cross-Sensor Correlation via OCSF Field Alignment~~ | CAP-012 | P1 | removed |
| BC-2.01.012 | ~~Query Fingerprint Validation at Startup~~ | CAP-001 | P0 | removed |
| BC-2.01.013 | DataSource Trait Eliminates Per-Sensor Code Duplication | CAP-001 | P0 | draft |
| BC-2.01.014 | Exponential Backoff and Retry for Transient Sensor API Errors | CAP-001 | P0 | draft |
| BC-2.01.015 | ~~MCP Tool Response Envelope Structure~~ | CAP-001 | P0 | removed |
...
|-----------|----------------|
| DI-001 (Cursor Forward Progress) | BC-2.01.004, BC-2.01.007, BC-2.01.008, BC-2.01.010 |
