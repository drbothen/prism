...
| VP ID | Description |
|-------|-------------|
| (placeholder) | VP to be assigned — verify virtual fields queryable in WHERE clause |
| (placeholder) | VP to be assigned — verify decorator fields always present (never null-struct) |
