...
seven categories of checks in a single pass: schema validation (field types, regex
...
in string fields before subsequent validation rules run), and HTTP method whitelist
