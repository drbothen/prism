...
| VP ID | Description |
|-------|-------------|
| (placeholder) | VP to be assigned — verify consecutive-only counter (intervening success resets) |
| (placeholder) | VP to be assigned — verify denylist survives restart |
