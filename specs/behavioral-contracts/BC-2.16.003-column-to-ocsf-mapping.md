...
3. Fix EC-016-013-007: `column_type = "string"` + Array input → `raw_extensions` with `CoercionWarning` (structured-type demotion; same burst as items 1–2) — AC-001, AC-005
