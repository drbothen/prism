...
| VP ID | Description |
|-------|-------------|
| (placeholder) | VP to be assigned — verify coercion-failure non-fatal (record not dropped) |
| (placeholder) | VP to be assigned — verify cross-sensor correlation via ocsf_field mapping |
