...
| BC-2.16.013 | Bundled Sensor Spec Authoring and DTU-Parity Verification — 4 Initial Sensors | 16 - Spec Engine | CAP-029 | P0 | draft (v1.8 FB-IMPL-P15-PO 2026-05-20 — F-LP15-MED-001 closure: ADR-028 v1.5→v1.6 cite-pin sweep across 6 active-prose sites; POL-29 cross-file sweep per F-LP15-OBS-001 process-gap) — v1.8 |
