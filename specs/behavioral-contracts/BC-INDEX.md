...
Flat index of all 110 behavioral contracts for Prism, organized by BC ID.
...
| BC-2.01.012 | Query Fingerprint Validation at Startup | 01 - Sensor Query Pipeline | CAP-001 | P0 | draft |
...
| BC-2.03.005 | Credential CRUD Operations via MCP Tools | 03 - Credential Management | CAP-004 | P0 | draft |
...
| BC-2.04.003 | Hierarchical Capability Resolution (Most-Specific to Least-Specific with Deny Fallback) | 04 - Feature Flag System | CAP-005 | P0 | draft |
...
| BC-2.04.009 | Confirmation Token Generation for Irreversible Write Operations | 04 - Feature Flag System | CAP-006 | P1 | draft |
...
| BC-2.04.014 | notifications/tools/list_changed on Client Context Switch | 04 - Feature Flag System | CAP-005 | P0 | draft |
| BC-2.04.015 | Structured Error When Write Capability Is Denied | 04 - Feature Flag System | CAP-005 | P0 | draft |
| BC-2.05.001 | Every MCP Tool Invocation Produces Exactly One Audit Entry | 05 - Audit & Compliance | CAP-007 | P0 | draft |
...
| BC-2.06.009 | Client Context Switch Triggers notifications/tools/list_changed | 06 - Client Configuration | CAP-009 | P0 | draft |
| BC-2.06.010 | Client ID Validation Enforces Allowed Character Set | 06 - Client Configuration | CAP-009 | P0 | draft |
| BC-2.07.001 | Cursor Is a Composite of Timestamp and RecordID | 07 - Cursor State Management | CAP-011 | P0 | draft |
| BC-2.07.002 | Cursor Regression Is Detected and Produces a Fatal Error | 07 - Cursor State Management | CAP-011 | P0 | draft |
| BC-2.07.003 | State Files Use Atomic Write Pattern (temp + fsync + rename) | 07 - Cursor State Management | CAP-011 | P0 | draft |
| BC-2.07.004 | Cursor State Is Persisted AFTER Successful Delivery | 07 - Cursor State Management | CAP-011 | P0 | draft |
| BC-2.07.005 | Query Fingerprint Is SHA-256 of Sorted Config Fields | 07 - Cursor State Management | CAP-011 | P0 | draft |
| BC-2.07.006 | Fingerprint Mismatch at Startup Is a Fatal Error | 07 - Cursor State Management | CAP-011 | P0 | draft |
| BC-2.07.007 | State Is Isolated Per-Client, Per-Sensor, Per-Source | 07 - Cursor State Management | CAP-011 | P0 | draft |
| BC-2.07.008 | MemoryStore Is Test-Only and Panics in Production | 07 - Cursor State Management | CAP-011 | P0 | draft |
| BC-2.07.009 | FileStore Is the Default and Only Production CursorStore | 07 - Cursor State Management | CAP-011 | P0 | draft |
| BC-2.07.010 | State File Directory Follows {client}/{sensor}/{source}.json | 07 - Cursor State Management | CAP-011 | P0 | draft |
...
| BC-2.10.004 | client_id Parameter on Every Tool | 10 - MCP Server & Transport | CAP-009 | P0 | draft |
| BC-2.10.005 | notifications/tools/list_changed on Client Context Switch | 10 - MCP Server & Transport | CAP-005 | P0 | draft |
...
| BC-2.10.010 | Graceful Shutdown on SIGTERM/SIGINT | 10 - MCP Server & Transport | CAP-011 | P0 | draft |
