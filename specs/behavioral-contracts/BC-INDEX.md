...
| BC-2.16.013 | Bundled Sensor Spec Authoring and DTU-Parity Verification — 4 Initial Sensors | 16 - Spec Engine | CAP-029 | P0 | draft (D-731 PLUGIN-MIGRATION-001-D PO authoring 2026-05-20; v1.2 FB-IMPL-P2-PO 2026-05-20 — auth_type strings corrected [claroty=cookie_roundtrip, cyberint=bearer_static], E-SPEC-017 introduced for filename-stem mismatch, fetch_page() phantom replaced with SensorAdapter::fetch(), ${query.aql}→${query.filter.aql} in test vectors, TD-VSDD-091 line-number citations removed) — v1.2 |
