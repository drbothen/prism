...
| VP ID | Description |
|-------|-------------|
| (placeholder) | VP to be assigned — verify in-flight query safety during hot reload |
| (placeholder) | VP to be assigned — verify cache invalidation for modified/removed sensors |
