...
## Subsystem 10: MCP Interface (Cross-Cutting) — 11 active BCs, 0 removed
...
| BC-2.10.005 | notifications/tools/list_changed on Config Reload | P0 | DI-003 |
...
| BC-2.10.010 | Graceful Shutdown on SIGTERM/SIGINT | P0 | DI-004, DI-026 |
...
| DI-003 (Feature Flag Deny-by-Default) | BC-2.10.001, BC-2.10.002, BC-2.10.003, BC-2.10.005, BC-2.10.011 *(DI-003 enforcement restored via BC-2.10.005 un-retired 2026-04-17 — notifications/tools/list_changed on Config Reload explicitly enforces deny-by-default notification behavior)* |
| DI-004 (Audit Completeness) | BC-2.08.001, BC-2.08.005, BC-2.08.007, BC-2.08.008, BC-2.08.009, BC-2.09.008, BC-2.10.001, BC-2.10.007, BC-2.10.010 |
...
| DI-026 (Audit Buffer Durability) | BC-2.10.010 |
...
- **Total active behavioral contracts:** 28 (9 + 8 + 11); 28 historical.
- **P0 contracts:** 19
