...
| ADR traces | ADR-046 v1.3 D1–D5, D7 |

## Changelog

| Version | Burst | Date | Author | Change |
|---------|-------|------|--------|--------|
| 1.2 (trace-pin hygiene) | F-P3-MED-002-adr-pin-correction | 2026-06-26 | product-owner | **F-P3-MED-002 closure — stale ADR trace-pin correction (hygiene only, no semantic change).** §Traceability `ADR traces` cell corrected from `ADR-046 v1.2 D1–D5, D7` to `ADR-046 v1.3 D1–D5, D7`, reflecting the ADR-046 version bump that occurred in the D-1357 burst. The "D1–D5, D7" decision-scope suffix is correct and unchanged. No preconditions, postconditions, invariants, edge cases, or error codes changed. BC semantic version is NOT bumped; this is a cross-reference label correction only. |
