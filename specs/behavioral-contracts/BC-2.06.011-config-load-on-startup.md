...
modified: [redirect-option-d-2026-05-08, D-319-post-merge-state-burst, PR-139-pr-level-pass-2-fix-pass, D-454, D-469]
deprecated: null
deprecated_by: null
replacement: null
retired: null
...
| 1.0 | redirect-option-d-2026-05-08 | 2026-05-08 | product-owner | Initial authorship (bundle-B-phase-B-1b) + same-burst relocation from BC-2.22.001 (SS-22) to BC-2.06.011 (SS-06 Client Configuration) per Option (d) decomposition. Capability anchor updated CAP-034 → CAP-009. EC/TV IDs renumbered to EC-06-011-NNN / TV-06-011-NNN. |
