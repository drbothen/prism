...
| Related BCs | BC-2.07.003 (cache), BC-2.02.002 (OCSF normalization), BC-2.01.013 v1.8 (SpecDrivenSensorAdapter OCSF Conformance Clause — spec-declared column survival and envelope derivation requirements) |
| Priority | P0 |
