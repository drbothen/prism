...
|---------|-------|------|--------|--------|
| 1.12 | prereq-e-fix-burst-14 | 2026-05-16 | product-owner | F-LP15-HIGH-001 sibling-sweep companion: §Postconditions + EC-016-012-005 cites of BC-2.16.002 §Postconditions Canonical Structured Event Catalog bullet advance (v1.19)→(v1.20) per BC-2.16.002 internal label sync in same burst. |
