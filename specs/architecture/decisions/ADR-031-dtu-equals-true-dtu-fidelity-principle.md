...
superseded_by: "ADR-053 §D3 (scope-narrowing only: §D3 single-surface assumption narrowed to Assets; §D3-a static-cookie CONTRACT PRESERVED — StaticCookieAuthProvider, access_token cookie name, no login step; §D3-b auth_type-keyed dispatch table superseded by header_scheme dispatch per ADR-053 D2/D5; Alerts becomes separate surface; Alerts auth CONFIRMED static-cookie per research-agent 2026-07-20; authorized D-1889 2026-07-20; final ADR approval gate pending)"
amends: null
