...
- Emission site: `prism-spec-engine::add_sensor_spec` — after Validation Rule 8 in `parse_and_validate_spec_toml`, or as a post-validation step in `add_sensor_spec`
