...
delivery. Phase: migration. Module: prism-spec-engine. (Rule 1 inline definition cross-references
...
COMMITTED v1.4, pending implementation of Wave 0/F (PLUGIN-PREREQ-F) and Constraints C1–C5
