...
| `VP-153` §Feasibility Assessment | Update "5 auth_type variants × 5 credential structural shapes = 25 pairs; all enumerable" → "6 auth_type variants × 5 credential structural shapes = 30 pairs; all enumerable" | D1 |
