...
| ADR-026 | SensorAuth Un-Sealing — Open Trait for Plugin-Implementable Auth; RwLock WriteToolInvalidationMap | PROPOSED v1.5 | 2026-05-15 | decisions/ADR-026-sensorauth-unsealing.md |
| ADR-027 | CustomAdapter Deprecation and Removal — Trait Retirement, Registry Cleanup, prism-query Scope | PROPOSED v1.2 | 2026-05-15 | decisions/ADR-027-custom-adapter-deprecation-removal.md |
