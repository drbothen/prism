...
|---------|-------|------|--------|--------|
| 1.19 | pass-15-remediation | 2026-04-27 | product-owner | m-15-002 / m-22-001 backfill: VP-001 description updated TenantId → OrgSlug per ADR-006 OrgId/OrgSlug rename (pass-14/15 OrgSlug sweep). |
