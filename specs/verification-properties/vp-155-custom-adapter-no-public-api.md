...
perimeter crate (ADR-023 §Verification Properties (VP-PLUGIN-001 bullet) enforcement mechanism 1). The compile-fail test joins
...
- **Supporting ADR:** ADR-027 §Decision (CustomAdapter deletion mandate) — D3 specifies the compile-fail perimeter enforcement mechanism that VP-155 implements. ADR-023 §Verification Properties (VP-PLUGIN-001 bullet) establishes the FORBIDDEN-SYMBOLS-001 catalog and perimeter pattern.
...
| 0.5 | prereq-e-fix-burst-9 | 2026-05-16 | architect | F-LP10-HIGH-001 — POL-21 phantom-anchor closure: §Property Statement + §Source Contract live-narrative `ADR-023 §VP-PLUGIN-001` → `ADR-023 §Verification Properties (VP-PLUGIN-001 bullet)`. Cross-perimeter sweep miss carried from PREREQ-D F-LP1-HIGH-003 era (FB1 swept story/BC bodies for §C5 phantom; never swept VP files or architecture-decision documents for §VP-PLUGIN-001 analog). |
