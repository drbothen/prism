...
| Edge Cases | edge-cases.md | ~1500 | Test Writer, Implementer | Specifies expected behavior for 19 boundary scenarios (DEC-001 through DEC-019; DEC-012 removed) |
...
| CAP-006 | DI-007, DI-015, DEC-009, DEC-016, DEC-017, DEC-019, R-012, FM-007 | Write gating constrained by token expiry and token cap; edge cases for expired/lost/capped tokens and concurrency; replay risk |
...
| CAP-011 | DI-001, DI-017, R-008 | Ephemeral cursor pagination constrained by pagination validity and single-process invariant |
...
| DEC-NNN | DEC-001 to DEC-019 (DEC-012 removed) | 18 | edge-cases.md |
