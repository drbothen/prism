...
#   18 Red Gate tests (RG-001..RG-018) + live verification support: 1.8 pt
#   Total: ~5.6 points
estimated_days: 1.5
risk: HIGH
# Risk justification:
...
**Acceptance criteria count:** 18 (AC-H2-001, AC-UA-001, AC-UA-002, AC-CARGO-001, AC-ERR-001..007, AC-WIRE-001, AC-SAP1-001, AC-QERR-001, AC-QERR-002, AC-LIVE-001..003)
**Density:** 18 / 18 = 1.0000 — PASSES (≥0.5 required by BC-5.38.001)
...
**Ordering rule (SAC-1 rule 3):** All Red Gate test authoring tasks (Phase 1 below) MUST be dispatched and completed BEFORE implementation tasks (Phase 2). The test-writer agent works from this story's RG-001..RG-018 list and the BC texts; the implementer receives the failing test suite before touching production code.
