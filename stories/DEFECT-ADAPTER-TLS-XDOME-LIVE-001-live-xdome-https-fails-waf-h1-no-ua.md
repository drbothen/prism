...
#   19 Red Gate tests (RG-001..RG-019) + live verification support: 1.9 pt
#   Total: ~5.7 points
estimated_days: 1.5
risk: HIGH
# Risk justification:
...
**Red Gate test count:** 19 (RG-001..RG-019)
**Acceptance criteria count:** 19 (AC-H2-001, AC-UA-001, AC-UA-002, AC-CARGO-001, AC-ERR-001..007, AC-WIRE-001, AC-WIRE-002, AC-SAP1-001, AC-QERR-001, AC-QERR-002, AC-LIVE-001..003)
**Density:** 19 / 19 = 1.0000 — PASSES (≥0.5 required by BC-5.38.001)
...
**Ordering rule (SAC-1 rule 3):** All Red Gate test authoring tasks (Phase 1 below) MUST be dispatched and completed BEFORE implementation tasks (Phase 2). The test-writer agent works from this story's RG-001..RG-019 list and the BC texts; the implementer receives the failing test suite before touching production code.
...
| `crates/prism-mcp/src/server.rs` | Conditional `sensor_errors` key in read-query response (T-QERR-3): include `sensor_errors` ONLY when non-empty (partial failure path); OMIT key entirely on success — not `null`, not `[]` (BC-2.11.001 absence invariant; wire-shape assertion per CLAUDE.md discipline; verified by RG-016) |
