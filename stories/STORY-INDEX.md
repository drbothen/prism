...
| S-PLUGIN-PREREQ-A | prism-core/prism-sensors: SensorType → SensorId(Arc<str>) Keystone Migration [PLUGIN-MIGRATION Wave 0] [ready] [v1.5 2026-05-11 D-394 PR-LEVEL pass-1 cascade closed; subsystems corrected; cache_key cluster added; AC-12] | prism-core,prism-sensors,prism-query,prism-spec-engine | 2 (BC-2.01.013, BC-2.16.004) | S-PLUGIN-PREREQ-F | 13 | S-PLUGIN-PREREQ-F |
