...
| S-PLUGIN-PREREQ-B | prism-spec-engine: Real PipelineExecutor — HTTP Client, JSONPath, Fan-out, Paginate, Retry, Declarative [PLUGIN-MIGRATION Wave 0] [draft v1.5 2026-05-11 D-408; fix-burst-5 CLOSED F-LP5-LOW-003; Red Gate 37→39; TD-010 CLOSED; pass-6 next] | prism-spec-engine | 2 (BC-2.16.002, BC-2.01.013) | S-PLUGIN-PREREQ-F,S-PLUGIN-PREREQ-A | 13 | S-PLUGIN-PREREQ-F,S-PLUGIN-PREREQ-A |
