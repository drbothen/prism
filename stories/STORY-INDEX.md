...
| S-PLUGIN-PREREQ-B | prism-spec-engine: Real PipelineExecutor — HTTP Client, JSONPath, Fan-out, Paginate, Retry, Declarative [PLUGIN-MIGRATION Wave 0] [draft v1.6 2026-05-11 D-410; fix-burst-6 CLOSED 5 findings (2H+3M); VP-PLUGIN-002/005 anchors fixed; NullAuth cfg-gated; execute_step eager-token; TD-011 filed; pass-7 next] | prism-spec-engine | 2 (BC-2.16.002, BC-2.01.013) | S-PLUGIN-PREREQ-F,S-PLUGIN-PREREQ-A | 13 | S-PLUGIN-PREREQ-F,S-PLUGIN-PREREQ-A |
