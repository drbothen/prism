...
| S-PLUGIN-PREREQ-B | prism-spec-engine: Real PipelineExecutor — HTTP Client, JSONPath, Fan-out, Paginate, Retry, Declarative [PLUGIN-MIGRATION Wave 0] [draft v1.7 2026-05-11 D-411; fix-burst-7 CLOSED 3M+1L(TD); red_gate 39→41; BC-2.16.002 v1.6 partial-record discard; FailingAuthProvider; pass-8 next] | prism-spec-engine | 2 (BC-2.16.002, BC-2.01.013) | S-PLUGIN-PREREQ-F,S-PLUGIN-PREREQ-A | 13 | S-PLUGIN-PREREQ-F,S-PLUGIN-PREREQ-A |
