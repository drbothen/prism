...
| S-PLUGIN-PREREQ-B | prism-spec-engine: Real PipelineExecutor — HTTP Client, JSONPath, Fan-out, Paginate, Retry, Declarative [PLUGIN-MIGRATION Wave 0] [draft v1.20 2026-05-12 D-424; pass-14 CLEAN; red_gate_tests=64; fix_bursts=13; local_adversary_passes=14; last_pass_verdict=CLEAN; streak 1/3; FIRST CLEAN after 13 BLOCKED-soft; trajectory 20→10→4→7→10→9→8→4→4→2→3→3→2→0] | prism-spec-engine | 2 (BC-2.16.002, BC-2.01.013) | S-PLUGIN-PREREQ-F,S-PLUGIN-PREREQ-A | 13 | S-PLUGIN-PREREQ-F,S-PLUGIN-PREREQ-A |
