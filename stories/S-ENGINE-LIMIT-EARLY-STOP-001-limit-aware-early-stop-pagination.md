...
input-hash: "019d29c"
# input-hash: verified 2026-08-29 (v1.39); inputs at ADR-060 §v1.16, BC-2.16.002 §v2.51, BC-2.16.015 §v1.8, ADR-061 §v1.2; prior provenance comment cited only ADR-060 §v1.14→v1.15 (v1.37 recompute); hash unchanged (019d29c confirmed current by validate-input-hash hook)
