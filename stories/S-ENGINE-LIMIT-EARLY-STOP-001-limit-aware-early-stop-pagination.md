...
input-hash: "b8cad49"
# input-hash: verified 2026-08-30 (v1.41); inputs at ADR-060 §v1.17, BC-2.16.002 §v2.53, BC-2.16.015 §v1.8, ADR-061 §v1.2; hash changed 8ae4906→b8cad49 (ADR-060 v1.16→v1.17 + BC-2.16.002 v2.52→v2.53 input drift; F-B1-001 propagation)
...
behavioral_contracts:
  ...
  # OffsetLimit (precise discriminator) + CursorToken/PaginationConfig::None (conservative `_ => 0` bucket per ADR-060 §D8.4); D8.5 ORDER BY limitation documented. BC-2.16.002 v2.53 (EC-01-042 non-final fan-out batch).
...
`crates/prism-spec-engine/tests/bc_2_16_002_early_stop_tests.rs` — already GREEN at code HEAD `704aac24a`)
