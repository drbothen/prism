...
input-hash: "6619823"
# input-hash: refreshed 2026-08-29 (v1.36); BC-2.16.002 bumped v2.50→v2.51 (ADR-060 §D8.4 cursor revert — CursorToken conservative-only; phantom-PageNumber removal); BC-2.11.001 bumped v1.29→v1.30; hash recomputed (stored 4d4c809 → 6619823)
