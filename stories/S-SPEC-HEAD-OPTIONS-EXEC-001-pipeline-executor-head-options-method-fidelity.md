...
# BC-2.16.009 v1.8 (active) defines the 7-method whitelist including HEAD and OPTIONS.
...
| BC-2.16.009 | v1.8 | No amendment needed — §VR7 already whitelists HEAD + OPTIONS | Context for why these methods must be executable |
...
(traces to BC-2.16.002 — belt-and-suspenders invariant per BC-2.16.009 v1.8 §VR7)
...
|------|--------|-------------|
| `build_request` match arms must cover all 7 BC-2.16.009 §VR7 whitelist members | BC-2.16.009 v1.8 §VR7 + SEC-002 closure | After this story: GET/POST/PUT/PATCH/DELETE/HEAD/OPTIONS each have explicit arms |
...
| `_ => reqwest::Method::GET` wildcard MUST remain | BC-2.16.009 v1.8 §VR7 "belt-and-suspenders" clause | Do NOT remove the wildcard — only ADD HEAD and OPTIONS arms before it |
...
| `.factory/specs/behavioral-contracts/BC-2.16.009-spec-file-validation.md` | READ ONLY | §VR7 whitelist context — already at v1.8; no amendment needed |
