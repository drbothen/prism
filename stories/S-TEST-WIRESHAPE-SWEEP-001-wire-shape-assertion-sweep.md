...
#   BC-2.10.007 v1.17: structured error response wire shape — all 9 required fields,
...
(traces to BC-2.10.007 v1.17 postcondition — structured error wire shape)
...
(traces to BC-2.10.007 v1.17 postcondition for error path; success path traces to BC-2.10.001
...
(traces to BC-2.10.007 v1.17 postcondition for error path)
...
(traces to BC-2.10.007 v1.17 postcondition)
...
(traces to BC-2.10.007 v1.17 postcondition for error paths)
...
| BC-2.10.007 v1.17 (structured error BC) | ~120 | ~1,700 |
