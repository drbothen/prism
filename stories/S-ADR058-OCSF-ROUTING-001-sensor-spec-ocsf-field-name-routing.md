...
**ADR-058 v2.32: v1 Column Naming — OCSF Field-Path Routing with Underscore-Flattened Arrow
Names; DTU Migration Deferred.** Version `2.32`, status: accepted (2026-08-23). Read
...
**BC-2.16.002: Multi-Step Fetch Pipeline Execution — Sequential Steps with Variable Interpolation.** Version `2.35`, status: active
...
**BC-2.11.016: Query Planner Column Resolution.** Version `1.31`, status: active
