...
(modified 2026-08-11). Primary behavioral authority. The §Type Coercion Algorithm, §Full
Coercion Matrix, EC-016-013-007/008/009 KNOWN GAP annotations, and §Coercion Warning
Observability DEFECT section are the acceptance-criteria source for this story.
Path: `.factory/specs/behavioral-contracts/BC-2.16.003-column-to-ocsf-mapping.md`.

**ADR-058 v2.0: v1 Column Naming — OCSF Field-Path Routing.** Version `2.0`, status:
accepted (2026-08-12). §H (Stage 1 Scope) enumerates the three deliverables this story
...
|----|---------|--------|-----------|
| BC-2.16.003 | v1.4 | draft | Primary contract — §Type Coercion Algorithm, §Full Coercion Matrix, EC-016-013-007/008/009 KNOWN GAPs, §Coercion Warning Observability DEFECT |
