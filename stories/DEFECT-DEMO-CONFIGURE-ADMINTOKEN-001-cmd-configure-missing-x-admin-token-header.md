...
|------|------|---------------------|----------------------|--------|
| `cmd_configure()` | `crates/prism-dtu-demo-server/src/main.rs` | ~561-572 | **NO** | **DEFECT SITE** |
| Test `ac_3_configure_called_on_clone_port_directly` | `tests/ac_3_configure_endpoint.rs` | ~44 | YES | Correct |
| Test `ac_3_no_harness_proxy_for_configure` | `tests/ac_3_configure_endpoint.rs` | ~94 | YES | Correct |
