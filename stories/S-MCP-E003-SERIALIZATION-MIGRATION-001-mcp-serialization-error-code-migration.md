...
status: draft
# BC status: BC-2.10.007 v1.15 is ACTIVE and governs this story. S-7.01 gate satisfied.
...
# BC status: BC-2.10.007 v1.15 is ACTIVE (lifecycle_status: active).
# BC-2.10.007 v1.15 §Implementer Code Follow-Up (OBS-002) is a REQUIRED implementer action
...
(traces to BC-2.10.007 v1.15 postcondition Rule 2 — dedicated VariantMeta arm class;
...
| Field | Required Value (per BC-2.10.007 v1.15 §OBS-002) |
|-------|--------------------------------------------------|
| `category` | `"internal"` |
...
(traces to BC-2.10.007 v1.15 postcondition — McpSerializationError variant produces E-MCP-003)
...
(traces to BC-2.10.007 v1.15 invariant — McpSerializationError is the ONLY correct variant
...
(traces to BC-2.10.007 v1.15 postcondition — McpSerializationError structured error fields)
...
| BC-2.10.007 v1.15 (postconditions, OBS-002 §Implementer Code Follow-Up) | ~8,000 |
