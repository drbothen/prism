...
#   BC-2.11.016 v1.16, BC-2.11.007 v1.9) + BC-2.11.019 v1.6 draft→active at merge per POL-14. Canonical versions
...
# --- AC-M2 HAVING column gate (BC-2.11.016 v1.16 — Position 6; inline in engine.rs,
...
| BC-2.11.016 | v1.16 | BC-2.11.016: E-QUERY-038 Column-Not-Found Plan-Time Gate (L4) |
...
**AC-M1** (traces to BC-2.11.016 v1.16 postcondition — E-QUERY-038 fires for unknown columns): The
...
**AC-M2** (traces to BC-2.11.016 v1.16 postcondition — E-QUERY-038 fires for unknown columns at
...
For the HAVING position specifically (BC-2.11.016 v1.16 §Implementation location gate-positions
table, Position 6):
