...
`RUSTFLAGS=""` convention. Together these eliminate the ~157s rebuild on every warm
`just check` run after clippy, and eliminate cross-recipe clippy recompilation when
...
|-------------------|-----------------|
| This story spec (v1.4, ~515 lines) | ~6,200 |
