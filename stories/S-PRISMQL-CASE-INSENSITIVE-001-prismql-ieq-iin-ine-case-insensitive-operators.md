...
#   BC-2.11.004 v1.48 (active, amended): pipe-mode | where stage now supports IEQ/IIN/INE
...
| BC-2.11.004 | v1.48 | PrismQL Pipe Mode | Amended: IEQ/IIN/INE available in \| where stages via shared filter grammar (ADR-046 D7); LOW-006 reserved-keyword fn-name exclusion (21-keyword list, NULL added v1.48 fix-burst-36); LOW-007 star-arg scope limit (doc-only, fix-burst 23); position-7 INSERT source_select WHERE scope added (fix-burst 24); HAVING-percentile → E-QUERY-001 adjudication (EC-11-086, v1.48 fix-burst-36) |
| BC-2.11.018 | v1.5 | normalized_pql Echo | Amended: EC-11-057 added — IEQ/IIN/INE predicates reflected in uppercase canonical form in normalized_pql; round-trip invariant extended |
...
BC-2.11.018 v1.5 amendment EC-11-057)
...
BC-2.11.018 v1.5 amendment: round-trip invariant extended to cover IEQ/IIN/INE)
...
12. **Add `case_insensitive` handling to the round-trip normalizer** in `ast.rs` —
    ...
    and BC-2.11.018 v1.5 amendment EC-11-057.
...
| v1.70 | 2026-07-14 | **BC-2.11.004 v1.44→v1.45 pin-sync (fix-burst 24 F-PQLFN-P32-OBS-001 position-7 INSERT source_select WHERE scope, POL-23).** PO bumped BC-2.11.004 v1.44→v1.45 (INSERT source_select WHERE added as seventh Predicate-typed query position; ADR-048 v1.12 §D.7 pin sweep — 10 live pins advanced to v1.13; aggregate-gate count "all six" → "all seven"; SHARED-PARSER SCOPE "ALL five" → "ALL six"). Four live version-pin cites updated: (1) frontmatter BC status comment (line 74); (2) §Behavioral Contracts body table version cell (line 171); (3) §Token Budget row (line 189); (4) AC-013b trace (line 407). Semantic-cell currency: BC-2.11.004 Key Clauses cell updated — position-7 INSERT source_select WHERE scope added "(fix-burst 24)". Exhaustive per-variant grep evidence (post-fix): Form A (`BC-2.11.004 v1.44`, space form): 0 live pins; Form B (`\| v1.44 \|`, bare cell form): 0 live pins; Form C (`v1.44` anywhere): remaining hits are historical changelog rows only. AC semantics UNCHANGED — position-7 scope extension is grammar/gate scope; IEQ/IIN/INE pipe-mode availability (AC-013b contract) not affected. error-taxonomy.md v2.49→v2.50: E-QUERY-039 DML WHERE coverage note corrected for split-coverage truth (INSERT source_select WHERE gated; projections/JOIN predicates/HAVING deferred to S-3.07). Frontmatter version 1.69→1.70; updated 2026-07-14 (POL-23). |
| v1.69 | 2026-07-14 | **BC-2.11.004 v1.43→v1.44 pin-sync (fix-burst 23 F-PQLFN-P31-OBS-001 LOW-007 star-arg scope limit).** PO bumped BC-2.11.004 v1.43→v1.44 (LOW-007 `Expr::Star` star-arg scope limit added — doc-only, no behavioral change to IEQ/IIN/INE availability). Four live version-pin cites updated: (1) frontmatter BC status comment (line 74); (2) §Behavioral Contracts body table version cell (line 171); (3) §Token Budget row (line 189); (4) AC-013b trace (line 407). Semantic-cell currency: BC-2.11.004 Key Clauses cell updated — LOW-007 status added "(doc-only, fix-burst 23)". Exhaustive per-variant grep evidence (post-fix): Form A (`BC-2.11.004 v1.43`, space form): 0 live pins; Form B (`\| v1.43 \|`, bare cell form): 0 live pins; Form C (`v1.43` anywhere): remaining hits are historical changelog rows only. AC semantics UNCHANGED — LOW-007 is a documentation-only scope limit; IEQ/IIN/INE pipe-mode availability (AC-013b contract) not affected. Frontmatter version 1.68→1.69; updated 2026-07-14 (POL-23). |
| v1.68 | 2026-07-14 | **BC-2.11.004 v1.42→v1.43 pin-sync (fix-burst 21 F-PQLFN-P27-LOW-001 + POL-23 ADR-048 v1.11→v1.12 pin advance). PO bumped BC-2.11.004 v1.42→v1.43 (9 live normative ADR-048 v1.11 pins advanced to v1.12 + LOW-006 implemented-marker truth; no behavioral change to IEQ/IIN/INE availability). Four live version-pin cites updated: (1) frontmatter BC status comment (line 74); (2) §Behavioral Contracts body table version cell (line 171); (3) §Token Budget row (line 189); (4) AC-013b trace (line 407). Semantic-cell currency: BC-2.11.004 Key Clauses cell updated — LOW-006 status changed from "(pending implementer fix-burst)" to "(implemented, fix-burst 20)". Exhaustive per-variant grep evidence (post-fix): Form A (`BC-2.11.004 v1.42`, space form): 0 live pins; Form B (`\| v1.42 \|`, bare cell form): 0 live pins; Form C (`v1.42` anywhere): remaining hits are historical changelog rows only. AC semantics UNCHANGED — LOW-006 implemented marker is status-update only; IEQ/IIN/INE pipe-mode availability (AC-013b contract) not affected. Frontmatter version 1.67→1.68; updated 2026-07-14 (POL-23). |
| v1.67 | 2026-07-14 | **BC-2.11.004 v1.41→v1.42 pin-sync (F-PQLFN-P26-OBS-001/002 fix-burst 20, POL-23). PO bumped BC-2.11.004 v1.41→v1.42 (LOW-002 compare-op 6→7 operators: `==` alias acknowledged; LOW-006 reserved-keyword fn-name exclusion added as contract requirement with implementer directive). Four live version-pin cites updated: (1) frontmatter BC status comment (line 74); (2) §Behavioral Contracts body table version cell (line 171); (3) §Token Budget row (line 189); (4) AC-013b trace (line 407). Exhaustive per-variant grep evidence (post-fix): Form A (`BC-2.11.004 v1.41`, space form): 0 live pins (lines 74/189/407 updated to v1.42 via replace_all); Form B (`\| v1.41 \|`, bare cell form): 0 live pins (line 171 updated to `\| v1.42 \|`); Form C (`v1.41` anywhere): remaining hits are historical changelog rows only (v1.66 entry "BC-2.11.004 v1.40→v1.41" and this v1.67 changelog narrative — both historical, unchanged). Semantic-cell currency: BC-2.11.004 Key Clauses cell updated to note LOW-006 reserved-keyword exclusion (pending implementer fix-burst). AC semantics UNCHANGED — LOW-006 is a new grammar requirement targeting fn-call names; IEQ/IIN/INE pipe-mode availability (AC-013b contract) is not affected. Frontmatter version 1.66→1.67; updated 2026-07-14 (POL-23). |
| v1.66 | 2026-07-13 | **BC-2.11.004 v1.40→v1.41 pin-sync (F-PQLFN-P21-OBS-001/002 fix-burst 16, POL-23). PO bumped BC-2.11.004 v1.40→v1.41 (LOW-002 full non-composable operator enumeration + LOW-005 fn-call-on-RHS scope limit; scope-limit documentation addition only; no behavioral change to IEQ/IIN/INE availability). Four live version-pin cites updated: (1) frontmatter BC status comment (line 74); (2) §Behavioral Contracts body table version cell (line 171); (3) §Token Budget row (line 189); (4) AC-013b trace (line 407). Exhaustive per-variant grep evidence (post-fix): Form A (`BC-2.11.004 v1.40`, space form): 0 live pins (lines 74/189/407 updated to v1.41); Form B (`\| v1.40 \|`, bare cell form): 0 live pins (line 171 updated to `\| v1.41 \|`); Form C (`v1.40` anywhere): all remaining hits are historical changelog rows only (v1.65 entry "BC-2.11.004 v1.39→v1.40" — historical, unchanged). Semantic-cell currency: BC-2.11.004 Key Clauses cell ("Amended: IEQ/IIN/INE available in \| where stages via shared filter grammar (ADR-046 D7)") UNCHANGED — v1.41 is scope-limit documentation addition (LOW-002 extended, LOW-005 added); no IEQ/IIN/INE availability amendment. AC semantics UNCHANGED. Frontmatter version 1.65→1.66; updated 2026-07-13 (POL-23). |
| v1.65 | 2026-07-13 | **BC-2.11.004 v1.39→v1.40 pin-sync (F-PQLFN-P19-MED-001 fix-burst pass-19, POL-23). PO bumped BC-2.11.004 v1.39→v1.40 (EC-11-004-006 one-sentence cross-reference to BC-2.11.005 DEC-022 Pipe-mode source pre-registration; no behavioral change). Four live version-pin cites updated: (1) frontmatter BC status comment (line 74); (2) §Behavioral Contracts body table version cell (line 171); (3) §Token Budget row (line 189); (4) AC-013b trace (line 407). Exhaustive per-variant grep evidence (post-fix): Form A (`BC-2.11.004 v1.39`, space form): 0 live pins (lines 74/189/407 updated to v1.40); Form B (`\| v1.39 \|`, bare cell form): 0 live pins (line 171 updated to `\| v1.40 \|`); Form C (`v1.39` anywhere): all remaining hits are historical changelog rows only (v1.64 entry "BC-2.11.004 v1.38→v1.39" — historical, unchanged). Semantic-cell currency: BC-2.11.004 Key Clauses cell ("Amended: IEQ/IIN/INE available in \| where stages via shared filter grammar (ADR-046 D7)") UNCHANGED — v1.40 is a cross-reference addition in EC-11-004-006 only; no IEQ/IIN/INE availability amendment; no Key Clauses extension needed. AC semantics UNCHANGED. Frontmatter version 1.64→1.65; updated 2026-07-13 (POL-23). |
| v1.64 | 2026-07-13 | **BC-2.11.004 v1.38→v1.39 pin-sync (F-PQLFN-P16-OBS-001, pass 16, POL-23). PO bumped BC-2.11.004 v1.38→v1.39 (audit-trail correction only — v1.39 corrects v1.38's undercount; body content unchanged at v1.38; no behavioral change). Four live version-pin cites updated: (1) frontmatter BC status comment (line 74); (2) §Behavioral Contracts body table version cell (line 171); (3) §Token Budget row (line 189); (4) AC-013b trace (line 407). Exhaustive per-variant grep evidence (post-fix): Form A (`BC-2.11.004 v1.38`, space form): 0 live pins (lines 74/189/407 updated to v1.39); Form B (`| v1.38 |`, bare cell form): 0 live pins (line 171 updated to `| v1.39 |`); Form C (`v1.38` anywhere): all remaining hits are historical changelog rows only (v1.63 entry "BC-2.11.004 v1.37→v1.38" — historical, unchanged). Semantic-cell currency: BC-2.11.004 Key Clauses cell ("Amended: IEQ/IIN/INE available in \| where stages via shared filter grammar (ADR-046 D7)") UNCHANGED — v1.39 is an audit-trail-only correction; no behavioral change. AC semantics UNCHANGED. Frontmatter version 1.63→1.64; updated 2026-07-13 (POL-23). |
| v1.63 | 2026-07-13 | **BC-2.11.004 v1.37→v1.38 pin-sync (F-PQLFN-P15-OBS-001, pass 15, POL-23). PO bumped BC-2.11.004 v1.37→v1.38 (ADR-048 v1.9→v1.11 pin advance for 6 live normative body sites; F-PQLFN-P15-OBS-001 per F-PQLFN-P10-LOW-001 precedent: pins advance when anchored ADR version advances). Four live version-pin cites updated: (1) frontmatter BC status comment (line 74); (2) §Behavioral Contracts body table version cell (line 171); (3) §Token Budget row (line 189); (4) AC-013b trace (line 407). Exhaustive per-variant grep evidence (post-fix): Form A (`BC-2.11.004 v1.37`, space form): 0 live pins (lines 74/189/407 updated to v1.38); Form B (`| v1.37 |`, bare cell form): 0 live pins (line 171 updated to `| v1.38 |`); Form C (`v1.37` anywhere): all remaining hits are historical changelog rows only (v1.62 entry "BC-2.11.004 v1.36→v1.37" — historical, unchanged). Semantic-cell currency: BC-2.11.004 Key Clauses cell ("Amended: IEQ/IIN/INE available in \| where stages via shared filter grammar (ADR-046 D7)") verified CURRENT — v1.38 is an ADR-048 pin-currency advance only; no behavioral change. AC semantics UNCHANGED. Frontmatter version 1.62→1.63; updated 2026-07-13 (POL-23). |
| v1.62 | 2026-07-13 | **BC-2.11.004 v1.36→v1.37 pin-sync (F-PQLFN-P10-HIGH-001 + F-PQLFN-P10-LOW-001 + grammar-constraint doc, pass 10, POL-23). PO bumped BC-2.11.004 v1.36→v1.37 (Full Display message form, ADR-048 v1.4→v1.9 pin advance, LOW-004 fn-name identifier-start constraint). Four live version-pin cites updated: (1) frontmatter BC status comment (line 74); (2) §Behavioral Contracts body table version cell (line 171, the pass-9 false-close site); (3) §Token Budget row (line 189); (4) AC-013b trace (line 407). Exhaustive per-variant grep evidence (post-fix): Form A (`BC-2.11.004 v1.36`, space form): 0 live pins (1 hit in v1.61 changelog row and 1 in v1.60 changelog row — historical, unchanged); Form B (`| v1.36 |`, bare cell form): 0 live pins (1 hit = story's own v1.60 changelog narrative — historical, unchanged); Form C (`v1.36` anywhere): all remaining hits are historical changelog rows only. Semantic-cell currency: BC-2.11.004 Key Clauses cell ("Amended: IEQ/IIN/INE available in \| where stages via shared filter grammar (ADR-046 D7)") verified CURRENT — v1.37 is a message-form correction + pin advance + grammar constraint doc; no pipe-mode IEQ availability amendment; no Key Clauses extension needed. AC semantics UNCHANGED. Frontmatter version 1.61→1.62; updated 2026-07-13 (POL-23). |
| v1.61 | 2026-07-13 | **F-PQLFN-P9-HIGH-001 closure — §Behavioral Contracts body table cell corrected (false-close from v1.60).** The v1.60 changelog row stated "(2) §Behavioral Contracts body table version cell" was updated from v1.35→v1.36 as part of F-PQLFN-P8-HIGH-002 (D-1720). That claim was INACCURATE — the grep pattern used (`BC-2.11.004 v1.35`, space form) cannot match the table-cell form `| BC-2.11.004 | v1.35 |`, so line 171 was never updated and remained stale at v1.35. Per POL-29 v1.19 lesson, combined/single-form regex is FORBIDDEN as sole verification — per-variant greps are required. **Fix applied at v1.61:** line 171 `| BC-2.11.004 | v1.35 |` → `| BC-2.11.004 | v1.36 |`. Historical changelog rows in v1.60, v1.59, v1.35, etc. left unchanged per TD-VSDD-091. **Exhaustive per-variant grep evidence (post-fix):** Form A (`BC-2.11.004 v1.35`, space form): 0 live pins (1 hit in v1.60 changelog row `v1.35→v1.36` — historical, unchanged); Form B (`| v1.35 |`, bare cell form): 0 live pins (1 hit on line 1700 = story's own v1.35 changelog row — historical, unchanged); Form C (any `v1.35` in file): 3 hits — all historical changelog rows (lines 1675, 1676, 1700) — unchanged. Frontmatter version 1.60→1.61; updated 2026-07-13. |
...
| v1.56 | 2026-07-13 | **BC-2.11.018 v1.3→v1.5 pin propagation (DEFECT-MCP-ROWSHAPE-NULLS-001 F-MCPNULL-P3-MED-001 POL-23). PO bumped BC-2.11.018 v1.3→v1.5 during pass-3 spec burst @7d725c74. Six live version-pin cites updated: (1) frontmatter BC status comment; (2) §Behavioral Contracts body table version cell; (3) §Token Budget row; (4) AC-014 trace (BC-2.11.018 v1.3 amendment EC-11-057); (5) AC-015 trace (BC-2.11.018 v1.3 amendment: round-trip invariant extended); (6) Tasks Phase 2 step 12 inline reference. Grep for stale v1.3 variants: zero hits after edits. Historical changelog rows contain prior v1.3 references — left unchanged per TD-VSDD-091-exempt (past-tense changelog records). No BC-2.11.001 or BC-2.15.009 pins present in this file. BC-2.11.018 Key Clauses cell verified CURRENT at v1.5 — EC-11-057 (IEQ/IIN/INE predicates in uppercase canonical form) and round-trip invariant extension unchanged; no adjacent-cell update needed. AC semantics UNCHANGED. Frontmatter version 1.55→1.56; updated 2026-07-13 (POL-23).** |
...
| v1.51 | 2026-07-09 | **pin-sync BC-2.11.004 v1.26→v1.27 / error-taxonomy v2.34→v2.35 / BC-2.16.002 v2.07→v2.08 (Injection-safety of `column` MCP-facing payload, CWE-116, ADV-PR-P1-MED-001/OBS-001) + semantic-cell currency (FIX-IEQ-ERRPATH-001 PR-LEVEL pass-1 story pin round). BC-2.11.004 v1.26→v1.27 (pin-only): four live sites updated — (1) frontmatter BC status comment; (2) §Behavioral Contracts body table version cell; (3) §Token Budget row; (4) AC-013b trace. error-taxonomy v2.34→v2.35: one live site (AC-022 body). BC-2.16.002 v2.07→v2.08: one live site (AC-018 body — 50-codepoint cap/SEC-002 cite updated). Semantic-cell currency: BC-2.11.004 Key Clauses cell ("Amended: IEQ/IIN/INE available in \| where stages via shared filter grammar (ADR-046 D7)") verified CURRENT — v1.27 is injection-safety companion pin, not a pipe-mode IEQ amendment; no Key Clauses extension needed. BC-2.16.002 v2.08 adds sanitize_for_log annotation to `column_not_found.rejected` catalog row; AC-018 cites BC-2.16.002 for `ocsf.enum_label_unrecognized` 50-codepoint caps (value/sensor_type) — cap semantics unchanged, no adjacent-cell update needed. BC-2.11.016, BC-2.11.017, and BC-2.11.020 not cited in this story. AC semantics UNCHANGED. Frontmatter version 1.50→1.51; updated 2026-07-09 (POL-23).** |
