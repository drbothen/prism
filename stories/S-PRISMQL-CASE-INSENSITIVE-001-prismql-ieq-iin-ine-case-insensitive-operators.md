...
#   BC-2.11.004 v1.45 (active, amended): pipe-mode | where stage now supports IEQ/IIN/INE
...
| BC-2.11.004 | v1.45 | PrismQL Pipe Mode | Amended: IEQ/IIN/INE available in \| where stages via shared filter grammar (ADR-046 D7); LOW-006 reserved-keyword fn-name exclusion (implemented, fix-burst 20); LOW-007 star-arg scope limit (doc-only, fix-burst 23); position-7 INSERT source_select WHERE scope added (fix-burst 24) |
...
| BC-2.11.004 v1.45 (relevant pipe-mode sections) | ~1,500 |
