...
#   BC-2.11.004 v1.42 (active, amended): pipe-mode | where stage now supports IEQ/IIN/INE
...
| BC-2.11.004 | v1.42 | PrismQL Pipe Mode | Amended: IEQ/IIN/INE available in \| where stages via shared filter grammar (ADR-046 D7); LOW-006 reserved-keyword fn-name exclusion (pending implementer fix-burst) |
...
| BC-2.11.004 v1.42 (relevant pipe-mode sections) | ~1,500 |
